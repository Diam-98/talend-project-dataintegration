...
/**
 * Job: jDWHClient Purpose: Alimentation de table Client_DWH<br>
 * Description: Permet d'alimenter la table Client_DWH. <br>
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ID_DIM_CLIENT\",\"DT_MISE_A_JOUR\",\"BL_LIGNE_ACTIVE\") VALUES (?,?,?)";
...
client_tmp.LB_TYPE_CLIENT = row2.LB_TYPE_CLIENT ;
client_tmp.LB_JOB_NAME = null;
client = client_tmp;
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row3HashKey.ID_CLIENT = client.ID_CLIENT ;
...
!client.NOM_CLIENT.equals(row3.NOM_CLIENT)
|| !client.PREN_CLIENT.equals(row3.PREN_CLIENT)
|| !client.ID_CLIENT.equals(row3.ID_CLIENT)
|| !client.VILLE_CLIENT.equals(row3.VILLE_CLIENT)
|| !client.PAYS_CLIENT.equals(row3.PAYS_CLIENT)
|| !client.REGION_CLIENT.equals(row3.REGION_CLIENT)
|| !client.CD_TYPE_CLIENT.equals(row3.CD_TYPE_CLIENT)
|| !client.LB_TYPE_CLIENT.equals(row3.LB_TYPE_CLIENT)
...
insertNewClient_tmp.ID_CLIENT = client.ID_CLIENT  ;
insertNewClient_tmp.NOM_CLIENT = client.NOM_CLIENT  ;
insertNewClient_tmp.PREN_CLIENT = client.PREN_CLIENT  ;
insertNewClient_tmp.CD_POSTAL_CLIENT = client.CD_POSTAL_CLIENT  ;
insertNewClient_tmp.VILLE_CLIENT = client.VILLE_CLIENT  ;
insertNewClient_tmp.PAYS_CLIENT = client.PAYS_CLIENT  ;
insertNewClient_tmp.REGION_CLIENT = client.REGION_CLIENT  ;
insertNewClient_tmp.CD_TYPE_CLIENT = client.CD_TYPE_CLIENT  ;
insertNewClient_tmp.LB_TYPE_CLIENT = client.LB_TYPE_CLIENT  ;
...
insertClient_tmp.LB_TYPE_CLIENT = client.LB_TYPE_CLIENT ;
...
if(updateBLCurrent != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, updateBLCurrent.ID_DIM_CLIENT);

                    if(updateBLCurrent.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_2.setTimestamp(2, new java.sql.Timestamp(updateBLCurrent.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(3, updateBLCurrent.BL_LIGNE_ACTIVE);
...
} else {pstmt_tDBOutput_3.setString(1, insertNewClient.ID_CLIENT);
}

                    if(insertNewClient.NOM_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewClient.NOM_CLIENT);
}

                    if(insertNewClient.PREN_CLIENT == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewClient.PREN_CLIENT);
}

                    if(insertNewClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, insertNewClient.CD_POSTAL_CLIENT);
}

                    if(insertNewClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, insertNewClient.VILLE_CLIENT);
}

                    if(insertNewClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertNewClient.PAYS_CLIENT);
}

                    if(insertNewClient.REGION_CLIENT == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, insertNewClient.REGION_CLIENT);
}

                    if(insertNewClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, insertNewClient.CD_TYPE_CLIENT);
}

                    if(insertNewClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, insertNewClient.LB_TYPE_CLIENT);
}

                    if(insertNewClient.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(insertNewClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(11, insertNewClient.BL_LIGNE_ACTIVE);

                    if(insertNewClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(12, insertNewClient.LB_JOB_NAME);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(client)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(client,row3) outputs:(insertClient,updateBLCurrent,insertNewClient)
...
/************************************************************************************************
 *     255964 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 août 2024 à 11:49:44 GMT
 ************************************************************************************************/