...
//System.out.println("Fin de la génération du calendrier.  : "+TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",new java.util.Date(((Long)globalMap.get("tChronometerStop_1_STOPTIME")))));

//System.out.println("Durée totale d'exécution             : "+customCode.getFormattedTime(((Long)globalMap.get]("tChronometerStop_1_DURATION"))) + "");
//System.out.println("-----------------------------------------------------------------------------");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Ih0YJ7yyWmOq7FE1bPyJSYy8u1JjsSKEy6mxgw==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/hp/Documents/studies_bi/stage-disi/Section 11/joursFeries.xlsx";
...
/************************************************************************************************
 * 179870 characters generated by Talend Open Studio for Data Integration on the
 * 27 août 2024 à 10:03:54 GMT
 ************************************************************************************************/