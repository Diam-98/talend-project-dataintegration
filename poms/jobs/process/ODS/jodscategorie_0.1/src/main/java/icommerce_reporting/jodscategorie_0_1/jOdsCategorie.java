...
/**
 * Job: jOdsCategorie Purpose: Aliment la table ODS.<br>
 * Description: Permet d'aliment la table ODS. <br>
 * 
...
public class jOdsCategorie implements TalendJob {
	...
	public static class insertCategoryStruct implements routines.system.IPersistableRow<insertCategoryStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCategorie = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCategorie = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final insertCategoryStruct other = (insertCategoryStruct) obj;
		...
		public void copyDataTo(insertCategoryStruct other) {
		...
		public void copyKeysDataTo(insertCategoryStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(insertCategoryStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				insertCategoryStruct insertCategory = new insertCategoryStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "insertCategory");
				}
...
// # Outputs initialization
				insertCategoryStruct insertCategory_tmp = new insertCategoryStruct();
...
// # Filter conditions 
												...
												!row3.LB_CATEGORIE.equals(row4.LB_CATEGORIE)
													...
													updateBLCurrent_tmp.LB_CATEGORIE = null;
													updateBLCurrent_tmp.LB_NOM_FICHIER = null;
													updateBLCurrent_tmp.DT_INSERTION = null;
													updateBLCurrent_tmp.BL_LIGNE_ACTIVE = 0;
													updateBLCurrent_tmp.LB_JOB_NAME = null;
...
// # Output reject table : 'insertCategory'
// # Filter conditions 
											if (rejectedInnerJoin_tMap_2) {
												insertCategory_tmp.CD_CATEGORIE = row3.CD_CATEGORIE;
												insertCategory_tmp.LB_CATEGORIE = row3.LB_CATEGORIE;
												insertCategory_tmp.LB_NOM_FICHIER = ((String) globalMap
														.get("tFileList_1_CURRENT_FILE"));
												insertCategory_tmp.DT_INSERTION = TalendDate.getCurrentDate();
												insertCategory_tmp.BL_LIGNE_ACTIVE = 1;
												insertCategory_tmp.LB_JOB_NAME = jobName;
												insertCategory = insertCategory_tmp;
											} // closing filter/reject
// ###############################
...
// Start of branch "insertCategory"
										if (insertCategory != null) {
											...
											if (insertCategory.CD_CATEGORIE == null) {
												pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(1, insertCategory.CD_CATEGORIE);
											}

											if (insertCategory.LB_CATEGORIE == null) {
												pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(2, insertCategory.LB_CATEGORIE);
											}

											if (insertCategory.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(3, insertCategory.LB_NOM_FICHIER);
											}

											if (insertCategory.DT_INSERTION != null) {
												pstmt_tDBOutput_1.setTimestamp(4,
														new java.sql.Timestamp(insertCategory.DT_INSERTION.getTime()));
											} else {
												pstmt_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
											}

											pstmt_tDBOutput_1.setInt(5, insertCategory.BL_LIGNE_ACTIVE);

											if (insertCategory.LB_JOB_NAME == null) {
												pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(6, insertCategory.LB_JOB_NAME);
											}
...
// # Output table : 'insertDuplicate'
											...
											insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_CATEGORIE + "|"
													+ row6.LB_CATEGORIE;
											insertDuplicate_tmp.LB_MESSAGE_REJET = "Donnee en doubles";
...
// # Output table : 'insertReject'
										...
										insertReject_tmp.LB_MESSAGE_REJET = "Valeures nulles pour certaine colonnes";
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "insertCategory");
				}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(updateBLCurrent,insertCategory,insertNewValueCategorie)
...
//tJava_1
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jOdsCategorie.class.getClassLoader().getResourceAsStream(
					"icommerce_reporting/jodscategorie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jOdsCategorie.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jOdsCategorie");
		}
...
/************************************************************************************************
 * 315564 characters generated by Talend Open Studio for Data Integration on the
 * 14 août 2024 à 11:06:28 GMT
 ************************************************************************************************/