...
public class jOdsClient implements TalendJob {
	...
	public static class rejectProduitDuplicatesStruct
			implements routines.system.IPersistableRow<rejectProduitDuplicatesStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public static class updateBLCurrentClientStruct
			implements routines.system.IPersistableRow<updateBLCurrentClientStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public static class insertNewValueClientStruct
			implements routines.system.IPersistableRow<insertNewValueClientStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsClient = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
...
// replace the following expression by your own filter condition 
								!numLigneClient.ID_CLIENT.isEmpty() && !numLigneClient.NOM_CLIENT.isEmpty()
...
// Start of branch "row3"
								if (row3 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row5.ID_CLIENT = row3.ID_CLIENT;
										row5.NOM_CLIENT = row3.NOM_CLIENT;
										row5.PREN_CLIENT = row3.PREN_CLIENT;
										row5.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT;
										row5.VILLE_CLIENT = row3.VILLE_CLIENT;
										row5.PAYS_CLIENT = row3.PAYS_CLIENT;
										row5.REGION_CLIENT = row3.REGION_CLIENT;
										row5.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT;
										row5.NUM_LIGNE = row3.NUM_LIGNE;
										...
										row4.NOM_CLIENT = row3.NOM_CLIENT;
										row4.PREN_CLIENT = row3.PREN_CLIENT;
										row4.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT;
										row4.VILLE_CLIENT = row3.VILLE_CLIENT;
										row4.PAYS_CLIENT = row3.PAYS_CLIENT;
										row4.REGION_CLIENT = row3.REGION_CLIENT;
										row4.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT;
										row4.NUM_LIGNE = row3.NUM_LIGNE;
...
// Start of branch "row5"
									if (row5 != null) {
										...
										if (tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G
											...
											// 'row6' and it contains more one result from keys : row6.CD_TYPE_CLIENT =
											// '" + row6HashKey.CD_TYPE_CLIENT + "'");
										} // G 071
...
// # Output table : 'typeClientManquant'
											typeClientManquant_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											typeClientManquant_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											typeClientManquant_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE;
											typeClientManquant_tmp.LB_LIGNE_REJET = row5.ID_CLIENT + "|"
													+ row5.NOM_CLIENT + "|" + row5.PREN_CLIENT + "|"
													+ row5.CD_POSTAL_CLIENT + "|" + row5.VILLE_CLIENT + "|"
													+ row5.PAYS_CLIENT + "|" + row5.REGION_CLIENT + "|"
													+ row5.CD_TYPE_CLIENT;
											typeClientManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> le code type client "
													+ row5.CD_TYPE_CLIENT
													+ " n'existe pas dans la table ODS_TYPE_CLIENT";
...
// Start of branch "client"
										if (client != null) {
											...
											if (tHash_Lookup_row7 != null
												...
												// row7.ID_CLIENT = '" + row7HashKey.ID_CLIENT + "'");
											} // G 071
...
// # Filter conditions 
													...
													!client.NOM_CLIENT.equals(row7.NOM_CLIENT)
														...
														insertNewValueClient_tmp.LB_NOM_FICHIER = ((String) globalMap
																.get("tFileList_1_CURRENT_FILE"));
														insertNewValueClient_tmp.DT_INSERTION = TalendDate
																.getCurrentDate();
...
// # Filter conditions 
												if (rejectedInnerJoin_tMap_5) {
													...
													insertClient_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILE"));
...
// Start of branch "updateBLCurrentClient"
											if (updateBLCurrentClient != null) {
												...
												if (updateBLCurrentClient.NOM_CLIENT == null) {
													...
													pstmt_tDBOutput_5.setString(1, updateBLCurrentClient.NOM_CLIENT);
												}

												if (updateBLCurrentClient.PREN_CLIENT == null) {
													pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_5.setString(2, updateBLCurrentClient.PREN_CLIENT);
												}
												...
												if (updateBLCurrentClient.CD_TYPE_CLIENT == null) {
													...
													pstmt_tDBOutput_5.setString(7,
															updateBLCurrentClient.CD_TYPE_CLIENT);
												}
												...
												if (updateBLCurrentClient.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_5.setString(11, updateBLCurrentClient.LB_JOB_NAME);
												}

												if (updateBLCurrentClient.ID_CLIENT == null) {
													pstmt_tDBOutput_5.setNull(12 + count_tDBOutput_5,
															java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_5.setString(12 + count_tDBOutput_5,
															updateBLCurrentClient.ID_CLIENT);
												}
...
// Start of branch "insertClient"
											if (insertClient != null) {
												...
												if (insertClient.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_4.setString(12, insertClient.LB_JOB_NAME);
												}
...
// Start of branch "insertNewValueClient"
											if (insertNewValueClient != null) {
												...
												if (insertNewValueClient.ID_CLIENT == null) {
													...
													pstmt_tDBOutput_6.setString(1, insertNewValueClient.ID_CLIENT);
												}

												if (insertNewValueClient.NOM_CLIENT == null) {
													pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_6.setString(2, insertNewValueClient.NOM_CLIENT);
												}

												if (insertNewValueClient.PREN_CLIENT == null) {
													pstmt_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_6.setString(3, insertNewValueClient.PREN_CLIENT);
												}
												...
												if (insertNewValueClient.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_6.setString(12, insertNewValueClient.LB_JOB_NAME);
												}
...
// Start of branch "typeClientManquant"
										if (typeClientManquant != null) {
											...
											if (typeClientManquant.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_3.setString(1, typeClientManquant.LB_CHEMIN_FICHIER);
											}

											if (typeClientManquant.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(2, typeClientManquant.LB_NOM_FICHIER);
											}
											...
											if (typeClientManquant.LB_JOB_NAME == null) {
												...
												pstmt_tDBOutput_3.setString(8, typeClientManquant.LB_JOB_NAME);
											}
											...
											if ((batchSize_tDBOutput_3 > 0)
												...
												try {
													...
													globalMap.put("tDBOutput_3_ERROR_MESSAGE",
...
// # Output table : 'rejectProduitDuplicates'
											rejectProduitDuplicates_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											rejectProduitDuplicates_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											rejectProduitDuplicates_tmp.NUM_LIGNE_REJET = row4.NUM_LIGNE;
											rejectProduitDuplicates_tmp.LB_LIGNE_REJET = row4.ID_CLIENT + "|"
													+ row4.NOM_CLIENT + "|" + row4.PREN_CLIENT + "|"
													+ row4.CD_POSTAL_CLIENT + "|" + row4.VILLE_CLIENT + "|"
													+ row4.PAYS_CLIENT + "|" + row4.REGION_CLIENT + "|"
													+ row4.CD_TYPE_CLIENT;
											rejectProduitDuplicates_tmp.LB_MESSAGE_REJET = "Lignes en doubles";
											rejectProduitDuplicates_tmp.LB_NOM_FLUX = ((String) globalMap
													.get("nom_flux"));
										...
										if (rejectProduitDuplicates != null) {
											...
											if (rejectProduitDuplicates.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_2.setString(1,
														rejectProduitDuplicates.LB_CHEMIN_FICHIER);
											}

											if (rejectProduitDuplicates.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(2, rejectProduitDuplicates.LB_NOM_FICHIER);
											}
											...
											if (rejectProduitDuplicates.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_2.setString(4, rejectProduitDuplicates.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_2 > 0) {
												if (rejectProduitDuplicates.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(1,
															rejectProduitDuplicates.LB_MESSAGE_REJET);
												}
												...
												if (rejectProduitDuplicates.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(4,
															rejectProduitDuplicates.LB_JOB_NAME);
												}
												...
												if (rejectProduitDuplicates.LB_NOM_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2,
															rejectProduitDuplicates.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2,
														rejectProduitDuplicates.NUM_LIGNE_REJET);
												...
												if (rejectProduitDuplicates.LB_LIGNE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2,
															rejectProduitDuplicates.LB_LIGNE_REJET);
												}
...
// # Output table : 'insertRejectClient'
										insertRejectClient_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILEPATH"));
										insertRejectClient_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILE"));
										insertRejectClient_tmp.NUM_LIGNE_REJET = row2.NUM_LIGNE;
										insertRejectClient_tmp.LB_LIGNE_REJET = row2.ID_CLIENT + "|" + row2.NOM_CLIENT
												+ "|" + row2.PREN_CLIENT + "|" + row2.CD_POSTAL_CLIENT + "|"
												+ row2.VILLE_CLIENT + "|" + row2.PAYS_CLIENT + "|" + row2.REGION_CLIENT
												+ "|" + row2.CD_TYPE_CLIENT;
...
// Start of branch "insertRejectClient"
									if (insertRejectClient != null) {
										...
										if (insertRejectClient.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_1.setString(1, insertRejectClient.LB_CHEMIN_FICHIER);
										}

										if (insertRejectClient.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, insertRejectClient.LB_NOM_FICHIER);
										}
										...
										if (insertRejectClient.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_1.setString(4, insertRejectClient.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_1 > 0) {
											if (insertRejectClient.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(1,
														insertRejectClient.LB_MESSAGE_REJET);
											}

											if (insertRejectClient.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_1.setString(2, insertRejectClient.LB_NOM_FLUX);
											}

											if (insertRejectClient.DT_REJET != null) {
												pstmtUpdate_tDBOutput_1.setTimestamp(3,
														new java.sql.Timestamp(insertRejectClient.DT_REJET.getTime()));
											} else {
											...
											if (insertRejectClient.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(4, insertRejectClient.LB_JOB_NAME);
											}
											...
											if (insertRejectClient.LB_CHEMIN_FICHIER == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1,
														insertRejectClient.LB_CHEMIN_FICHIER);
											}
											...
											if (insertRejectClient.LB_NOM_FICHIER == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1,
														insertRejectClient.LB_NOM_FICHIER);
											}

											pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1,
													insertRejectClient.NUM_LIGNE_REJET);
											...
											if (insertRejectClient.LB_LIGNE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1,
														insertRejectClient.LB_LIGNE_REJET);
											}
											...
											if (insertRejectClient.LB_NOM_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_1.setString(2, insertRejectClient.LB_NOM_FICHIER);
											}
											...
											if (insertRejectClient.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_1.setString(4, insertRejectClient.LB_LIGNE_REJET);
											}
											...
											if (insertRejectClient.LB_NOM_FLUX == null) {
												...
												pstmtInsert_tDBOutput_1.setString(6, insertRejectClient.LB_NOM_FLUX);
											}
											...
											if (insertRejectClient.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_1.setString(8, insertRejectClient.LB_JOB_NAME);
											}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"" + context.schema_ods
						...
						+ "\".\"ODS_TYPE_CLIENT\".\"LB_TYPE_CLIENT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_TYPE_CLIENT\".\"LB_NOM_FICHIER\", \n  \"" + context.schema_ods
						+ "\".\"ODS_TYPE_CLIENT\".\"DT_INSERTION\", \n  \"" + context.schema_ods
						+ "\".\"ODS_TYPE_CLIENT\".\"BL_LIGNE_ACTIVE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_TYPE_CLIENT\".\"LB_JOB_NAME\"\nFROM \"" + context.schema_ods
						+ "\".\"ODS_TYPE_CLIENT\"";
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_5 - inputs:(client,row7)
				// outputs:(updateBLCurrentClient,insertClient,insertNewValueClient)
...
//tJava_1
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jOdsClient.class.getClassLoader()
					.getResourceAsStream("icommerce_reporting/jodsclient_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jOdsClient.class.getClassLoader()
...
/************************************************************************************************
 * 417117 characters generated by Talend Open Studio for Data Integration on the
 * 20 août 2024 à 16:22:24 GMT
 ************************************************************************************************/