...
public class jOdsVente implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_Implicit_Context_Database = "jdbc:postgresql://" + context.serverName + ":" + context.port
						+ "/" + context.database + "?" + context.additionnalParam;
					...
					while (rs_Implicit_Context_Database.next()) {
						...
						if (tmp_key_Implicit_Context_Context != null) {
							try {
								...
								if (key_Implicit_Context_Context != null
										&& "additionnalParam".equals(key_Implicit_Context_Context)) {
								...
								if (key_Implicit_Context_Context != null
										&& "encoding".equals(key_Implicit_Context_Context)) {
								...
								if (key_Implicit_Context_Context != null
										&& "projetFolder".equals(key_Implicit_Context_Context)) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					System.err.println("Le repertoire " + TalendDate.getDate("YYYYMMDD")
							+ " ne contient pas de fichier categorie veuillez ajouter et ressayer.");

					globalMap.put("tDie_1_DIE_MESSAGE", "Le repertoire " + TalendDate.getDate("YYYYMMDD")
							+ " ne contient pas de fichier categorie veuillez ajouter et ressayer.");
					globalMap.put("tDie_1_DIE_MESSAGES", "Le repertoire " + TalendDate.getDate("YYYYMMDD")
							+ " ne contient pas de fichier categorie veuillez ajouter et ressayer.");
	...
	public static class insertDuplicatesVenteStruct
			implements routines.system.IPersistableRow<insertDuplicatesVenteStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								((String) globalMap.get("tFileList_1_CURRENT_FILEPATH")), context.encoding,
...
// replace the following expression by your own filter condition 
								!venteNumLigne.ID_VENTE.isEmpty() && !venteNumLigne.CD_PRODUIT.isEmpty()
										&& venteNumLigne.DT_VENTE != null && !venteNumLigne.ID_CLIENT.isEmpty()
										&& venteNumLigne.QTE_VENTE != null && venteNumLigne.PRIX_ACHAT != null
										&& venteNumLigne.PRIX_VENTE != null), "advanced condition failed");
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row5.ID_VENTE = row2.ID_VENTE;
										row5.CD_PRODUIT = row2.CD_PRODUIT;
										row5.DT_VENTE = row2.DT_VENTE;
										row5.ID_CLIENT = row2.ID_CLIENT;
										row5.QTE_VENTE = row2.QTE_VENTE;
										row5.PRIX_ACHAT = row2.PRIX_ACHAT;
										row5.PRIX_VENTE = row2.PRIX_VENTE;
										row5.NUM_LIGNE = row2.NUM_LIGNE;
										...
										row4.ID_VENTE = row2.ID_VENTE;
										row4.CD_PRODUIT = row2.CD_PRODUIT;
										row4.DT_VENTE = row2.DT_VENTE;
										row4.ID_CLIENT = row2.ID_CLIENT;
										row4.QTE_VENTE = row2.QTE_VENTE;
										row4.PRIX_ACHAT = row2.PRIX_ACHAT;
										row4.PRIX_VENTE = row2.PRIX_VENTE;
										row4.NUM_LIGNE = row2.NUM_LIGNE;
...
// Start of branch "row5"
									if (row5 != null) {
										...
										if (tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G
											...
											// 'row6' and it contains more one result from keys : row6.ID_CLIENT = '" +
											// row6HashKey.ID_CLIENT + "'");
										} // G 071
...
// # Filter conditions 
											if (rejectedInnerJoin_tMap_4) {
												...
												ClientManquant_tmp.LB_LIGNE_REJET = row5.ID_VENTE + "|"
														+ row5.CD_PRODUIT + "|" + row5.DT_VENTE + "|" + row5.ID_CLIENT
														+ "|" + row5.QTE_VENTE + "|" + row5.PRIX_ACHAT + "|"
														+ row5.PRIX_VENTE;
												ClientManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> Client "
														+ row5.ID_CLIENT + " n'existe pas dans la table ODS_CLIENT";
...
// Start of branch "venteClient"
										if (venteClient != null) {
											...
											if (tHash_Lookup_row7 != null
												...
												// row7.CD_PRODUIT = '" + row7HashKey.CD_PRODUIT + "'");
											} // G 071
...
// # Filter conditions 
												if (rejectedInnerJoin_tMap_5) {
													...
													produitManquant_tmp.LB_LIGNE_REJET = venteClient.ID_VENTE + "|"
															+ venteClient.CD_PRODUIT + "|" + venteClient.DT_VENTE + "|"
															+ venteClient.ID_CLIENT + "|" + venteClient.QTE_VENTE + "|"
															+ venteClient.PRIX_ACHAT + "|" + venteClient.PRIX_VENTE;
													produitManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> Produit "
															+ venteClient.CD_PRODUIT
															+ " n'existe pas dans la table ODS_PRODUIT";
													produitManquant_tmp.LB_NOM_FLUX = ((String) globalMap
															.get("nom_flux"));
...
// Start of branch "venteProduit"
											if (venteProduit != null) {
												...
												if (tHash_Lookup_row8 != null
													...
													// row8.ID_VENTE = '" + row8HashKey.ID_VENTE + "'");
												} // G 071
...
// # Output table : 'venteExistante'
													venteExistante_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILEPATH"));
													venteExistante_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILE"));
													venteExistante_tmp.NUM_LIGNE_REJET = venteProduit.NUM_LIGNE;
													venteExistante_tmp.LB_LIGNE_REJET = venteProduit.ID_VENTE + "|"
															+ venteProduit.CD_PRODUIT + "|" + venteProduit.DT_VENTE
															+ "|" + venteProduit.ID_CLIENT + "|"
															+ venteProduit.QTE_VENTE + "|" + venteProduit.PRIX_ACHAT
															+ "|" + venteProduit.PRIX_VENTE;
													venteExistante_tmp.LB_MESSAGE_REJET = "Donnees deja insere dans la table";
													venteExistante_tmp.LB_NOM_FLUX = ((String) globalMap
															.get("nom_flux"));
...
// Start of branch "insertVente"
												if (insertVente != null) {
													...
													if (insertVente.ID_VENTE == null) {
														...
														pstmt_tDBOutput_5.setString(1, insertVente.ID_VENTE);
													}

													if (insertVente.CD_PRODUIT == null) {
														pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
													} else {
														pstmt_tDBOutput_5.setString(2, insertVente.CD_PRODUIT);
													}

													if (insertVente.DT_VENTE != null) {
														pstmt_tDBOutput_5.setTimestamp(3,
													...
													if (insertVente.ID_CLIENT == null) {
														...
														pstmt_tDBOutput_5.setString(4, insertVente.ID_CLIENT);
													}
													...
													if (insertVente.LB_NOM_FICHIER == null) {
														...
														pstmt_tDBOutput_5.setString(8, insertVente.LB_NOM_FICHIER);
													}

													if (insertVente.DT_INSERTION != null) {
														pstmt_tDBOutput_5.setTimestamp(9, new java.sql.Timestamp(
													...
													if (insertVente.LB_JOB_NAME == null) {
														...
														pstmt_tDBOutput_5.setString(10, insertVente.LB_JOB_NAME);
													}
												...
												if (venteExistante != null) {
													...
													if (venteExistante.LB_CHEMIN_FICHIER == null) {
														...
														pstmt_tDBOutput_6.setString(1,
																venteExistante.LB_CHEMIN_FICHIER);
													}

													if (venteExistante.LB_NOM_FICHIER == null) {
														pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
													} else {
														pstmt_tDBOutput_6.setString(2, venteExistante.LB_NOM_FICHIER);
													}
													...
													if (venteExistante.LB_LIGNE_REJET == null) {
														...
														pstmt_tDBOutput_6.setString(4, venteExistante.LB_LIGNE_REJET);
													}

													if (venteExistante.LB_MESSAGE_REJET == null) {
														pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
													} else {
														pstmt_tDBOutput_6.setString(5, venteExistante.LB_MESSAGE_REJET);
													}

													if (venteExistante.LB_NOM_FLUX == null) {
														pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
													} else {
														pstmt_tDBOutput_6.setString(6, venteExistante.LB_NOM_FLUX);
													}

													if (venteExistante.DT_REJET != null) {
														pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(
																venteExistante.DT_REJET.getTime()));
													} else {
													...
													if (venteExistante.LB_JOB_NAME == null) {
														...
														pstmt_tDBOutput_6.setString(8, venteExistante.LB_JOB_NAME);
													}
...
// Start of branch "produitManquant"
											if (produitManquant != null) {
												...
												if (produitManquant.LB_CHEMIN_FICHIER == null) {
													...
													pstmt_tDBOutput_4.setString(1, produitManquant.LB_CHEMIN_FICHIER);
												}

												if (produitManquant.LB_NOM_FICHIER == null) {
													pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(2, produitManquant.LB_NOM_FICHIER);
												}
												...
												if (produitManquant.LB_LIGNE_REJET == null) {
													...
													pstmt_tDBOutput_4.setString(4, produitManquant.LB_LIGNE_REJET);
												}

												if (produitManquant.LB_MESSAGE_REJET == null) {
													pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(5, produitManquant.LB_MESSAGE_REJET);
												}

												if (produitManquant.LB_NOM_FLUX == null) {
													pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(6, produitManquant.LB_NOM_FLUX);
												}
												...
												if (produitManquant.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_4.setString(8, produitManquant.LB_JOB_NAME);
												}
												...
												if ((batchSize_tDBOutput_4 > 0)
													...
													try {
														...
														globalMap.put("tDBOutput_4_ERROR_MESSAGE",
...
// Start of branch "ClientManquant"
										if (ClientManquant != null) {
											...
											if (ClientManquant.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_3.setString(1, ClientManquant.LB_CHEMIN_FICHIER);
											}

											if (ClientManquant.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FICHIER);
											}
											...
											if (ClientManquant.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_3.setString(4, ClientManquant.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_3 > 0) {
												...
												if (ClientManquant.LB_NOM_FLUX == null) {
													...
													pstmtUpdate_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FLUX);
												}

												if (ClientManquant.DT_REJET != null) {
													pstmtUpdate_tDBOutput_3.setTimestamp(3,
															new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
												} else {
												...
												if (ClientManquant.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_3.setString(4, ClientManquant.LB_JOB_NAME);
												}

												if (ClientManquant.LB_CHEMIN_FICHIER == null) {
													pstmtUpdate_tDBOutput_3.setNull(5 + count_tDBOutput_3,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_3.setString(5 + count_tDBOutput_3,
												...
												if (ClientManquant.LB_NOM_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3,
															ClientManquant.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_3.setInt(7 + count_tDBOutput_3,
														ClientManquant.NUM_LIGNE_REJET);

												if (ClientManquant.LB_LIGNE_REJET == null) {
													pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3,
												...
												if (ClientManquant.LB_NOM_FICHIER == null) {
													...
													pstmtInsert_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FICHIER);
												}
												...
												if (ClientManquant.LB_LIGNE_REJET == null) {
													...
													pstmtInsert_tDBOutput_3.setString(4, ClientManquant.LB_LIGNE_REJET);
												}
												...
												if (ClientManquant.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_3.setString(6, ClientManquant.LB_NOM_FLUX);
												}

												if (ClientManquant.DT_REJET != null) {
													pstmtInsert_tDBOutput_3.setTimestamp(7,
															new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
												} else {
												...
												if (ClientManquant.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_3.setString(8, ClientManquant.LB_JOB_NAME);
												}
...
// # Output table : 'insertDuplicatesVente'
											insertDuplicatesVente_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											insertDuplicatesVente_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											insertDuplicatesVente_tmp.NUM_LIGNE_REJET = row4.NUM_LIGNE;
											insertDuplicatesVente_tmp.LB_LIGNE_REJET = row4.ID_VENTE + "|"
													+ row4.CD_PRODUIT + "|" + row4.DT_VENTE + "|" + row4.ID_CLIENT + "|"
													+ row4.QTE_VENTE + "|" + row4.PRIX_ACHAT + "|" + row4.PRIX_VENTE;
											insertDuplicatesVente_tmp.LB_MESSAGE_REJET = "Lignes en doubles";
											insertDuplicatesVente_tmp.LB_NOM_FLUX = ((String) globalMap
													.get("nom_flux"));
...
// Start of branch "insertDuplicatesVente"
										if (insertDuplicatesVente != null) {
											...
											if (insertDuplicatesVente.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_2.setString(1, insertDuplicatesVente.LB_CHEMIN_FICHIER);
											}

											if (insertDuplicatesVente.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(2, insertDuplicatesVente.LB_NOM_FICHIER);
											}
											...
											if (insertDuplicatesVente.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_2.setString(4, insertDuplicatesVente.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_2 > 0) {
												if (insertDuplicatesVente.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(1,
															insertDuplicatesVente.LB_MESSAGE_REJET);
												}
												...
												if (insertDuplicatesVente.LB_NOM_FLUX == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(2,
															insertDuplicatesVente.LB_NOM_FLUX);
												}

												if (insertDuplicatesVente.DT_REJET != null) {
													pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(
															insertDuplicatesVente.DT_REJET.getTime()));
												} else {
												...
												if (insertDuplicatesVente.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(4,
															insertDuplicatesVente.LB_JOB_NAME);
												}
												...
												if (insertDuplicatesVente.LB_CHEMIN_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2,
															insertDuplicatesVente.LB_CHEMIN_FICHIER);
												}

												if (insertDuplicatesVente.LB_NOM_FICHIER == null) {
													pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2,
															insertDuplicatesVente.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2,
														insertDuplicatesVente.NUM_LIGNE_REJET);
												...
												if (insertDuplicatesVente.LB_LIGNE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2,
															insertDuplicatesVente.LB_LIGNE_REJET);
												}
												...
												pstmtInsert_tDBOutput_2.setInt(3,
														insertDuplicatesVente.NUM_LIGNE_REJET);
												...
												if (insertDuplicatesVente.DT_REJET != null) {
													pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(
															insertDuplicatesVente.DT_REJET.getTime()));
												} else {
...
// # Output table : 'insertRejectVente'
										insertRejectVente_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILEPATH"));
										insertRejectVente_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILE"));
										insertRejectVente_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE;
										insertRejectVente_tmp.LB_LIGNE_REJET = row3.ID_VENTE + "|" + row3.CD_PRODUIT
												+ "|" + row3.DT_VENTE + "|" + row3.ID_CLIENT + "|" + row3.QTE_VENTE
												+ "|" + row3.PRIX_ACHAT + "|" + row3.PRIX_VENTE;
...
// Start of branch "insertRejectVente"
									if (insertRejectVente != null) {
										...
										if (insertRejectVente.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_1.setString(1, insertRejectVente.LB_CHEMIN_FICHIER);
										}

										if (insertRejectVente.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FICHIER);
										}
										...
										if (insertRejectVente.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_1.setString(4, insertRejectVente.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_1 > 0) {
											if (insertRejectVente.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(1,
														insertRejectVente.LB_MESSAGE_REJET);
											}

											if (insertRejectVente.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FLUX);
											}

											if (insertRejectVente.DT_REJET != null) {
												pstmtUpdate_tDBOutput_1.setTimestamp(3,
														new java.sql.Timestamp(insertRejectVente.DT_REJET.getTime()));
											} else {
											...
											if (insertRejectVente.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(4, insertRejectVente.LB_JOB_NAME);
											}
											...
											if (insertRejectVente.LB_CHEMIN_FICHIER == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1,
														insertRejectVente.LB_CHEMIN_FICHIER);
											}
											...
											if (insertRejectVente.LB_NOM_FICHIER == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1,
														insertRejectVente.LB_NOM_FICHIER);
											}

											pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1,
													insertRejectVente.NUM_LIGNE_REJET);
											...
											if (insertRejectVente.LB_LIGNE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1,
														insertRejectVente.LB_LIGNE_REJET);
											}
											...
											if (insertRejectVente.LB_NOM_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FICHIER);
											}
											...
											if (insertRejectVente.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_1.setString(4, insertRejectVente.LB_LIGNE_REJET);
											}
											...
											if (insertRejectVente.LB_NOM_FLUX == null) {
												...
												pstmtInsert_tDBOutput_1.setString(6, insertRejectVente.LB_NOM_FLUX);
											}
											...
											if (insertRejectVente.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_1.setString(8, insertRejectVente.LB_JOB_NAME);
											}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_5 - inputs:(venteClient,row7)
				// outputs:(venteProduit,produitManquant)
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_6 - inputs:(venteProduit,row8)
				// outputs:(insertVente,venteExistante)
...
/************************************************************************************************
 * 477119 characters generated by Talend Open Studio for Data Integration on the
 * 21 août 2024 à 12:04:00 GMT
 ************************************************************************************************/