...
public class jOdsSousCategorie implements TalendJob {
	...
	public static class insertNewValueSousCategorieStruct
			implements routines.system.IPersistableRow<insertNewValueSousCategorieStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public static class CategorieManquantesStruct
			implements routines.system.IPersistableRow<CategorieManquantesStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsSousCategorie = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row1.CD_SOUS_CATEGORIE = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							row1.LB_SOUS_CATEGORIE = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
...
// replace the following expression by your own filter condition 
								!sous_categorie.CD_SOUS_CATEGORIE.isEmpty()
										...
										&& !sous_categorie.CD_CATEGORIE.isEmpty()), "advanced condition failed");
...
// Start of branch "row3"
								if (row3 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row5.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE;
										row5.LB_SOUS_CATEGORIE = row3.LB_SOUS_CATEGORIE;
										row5.NUM_LIGNE = row3.NUM_LIGNE;
										row5.CD_CATEGORIE = row3.CD_CATEGORIE;
										...
										row4.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE;
										row4.LB_SOUS_CATEGORIE = row3.LB_SOUS_CATEGORIE;
										row4.NUM_LIGNE = row3.NUM_LIGNE;
										row4.CD_CATEGORIE = row3.CD_CATEGORIE;
...
// Start of branch "row5"
									if (row5 != null) {
										...
										if (tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G
											...
											// 'row7' and it contains more one result from keys : row7.CD_CATEGORIE = '"
											// + row7HashKey.CD_CATEGORIE + "'");
										} // G 071
...
// Start of branch "sousCategorie"
										if (sousCategorie != null) {
											...
											if (tHash_Lookup_row6 != null
												...
												// row6.CD_SOUS_CATEGORIE = '" + row6HashKey.CD_SOUS_CATEGORIE + "'");
											} // G 071
...
// # Filter conditions 
													...
													!sousCategorie.LB_SOUS_CATEGORIE.equals(row6.CD_SOUS_CATEGORIE)
															|| !sousCategorie.CD_CATEGORIE.equals(row6.CD_CATEGORIE)
...
// # Filter conditions 
													...
													!sousCategorie.LB_SOUS_CATEGORIE.equals(row6.CD_SOUS_CATEGORIE)
														...
														insertNewValueSousCategorie_tmp.LB_NOM_FICHIER = ((String) globalMap
																.get("tFileList_1_CURRENT_FILE"));
														insertNewValueSousCategorie_tmp.DT_INSERTION = TalendDate
																.getCurrentDate();
...
// # Filter conditions 
												if (rejectedInnerJoin_tMap_4) {
													...
													insertSousCategory_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILE"));
											...
											if (insertSousCategory != null) {
												...
												if (insertSousCategory.CD_SOUS_CATEGORIE == null) {
													...
													pstmt_tDBOutput_3.setString(1,
															insertSousCategory.CD_SOUS_CATEGORIE);
												}
												...
												if (insertSousCategory.LB_SOUS_CATEGORIE == null) {
													...
													pstmt_tDBOutput_3.setString(2,
															insertSousCategory.LB_SOUS_CATEGORIE);
												}

												if (insertSousCategory.CD_CATEGORIE == null) {
													pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_3.setString(3, insertSousCategory.CD_CATEGORIE);
												}

												if (insertSousCategory.LB_NOM_FICHIER == null) {
													pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_3.setString(4, insertSousCategory.LB_NOM_FICHIER);
												}

												if (insertSousCategory.DT_INSERTION != null) {
													pstmt_tDBOutput_3.setTimestamp(5, new java.sql.Timestamp(
															insertSousCategory.DT_INSERTION.getTime()));
												} else {
												...
												if (insertSousCategory.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_3.setString(7, insertSousCategory.LB_JOB_NAME);
												}
...
// Start of branch "updateBLCurrentSC"
											if (updateBLCurrentSC != null) {
												...
												if (updateBLCurrentSC.LB_SOUS_CATEGORIE == null) {
													...
													pstmt_tDBOutput_4.setString(1, updateBLCurrentSC.LB_SOUS_CATEGORIE);
												}

												if (updateBLCurrentSC.CD_CATEGORIE == null) {
													pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(2, updateBLCurrentSC.CD_CATEGORIE);
												}

												if (updateBLCurrentSC.LB_NOM_FICHIER == null) {
													pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(3, updateBLCurrentSC.LB_NOM_FICHIER);
												}

												if (updateBLCurrentSC.DT_INSERTION != null) {
													pstmt_tDBOutput_4.setTimestamp(4, new java.sql.Timestamp(
															updateBLCurrentSC.DT_INSERTION.getTime()));
												} else {
												...
												if (updateBLCurrentSC.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_4.setString(6, updateBLCurrentSC.LB_JOB_NAME);
												}

												if (updateBLCurrentSC.CD_SOUS_CATEGORIE == null) {
													pstmt_tDBOutput_4.setNull(7 + count_tDBOutput_4,
															java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_4.setString(7 + count_tDBOutput_4,
															updateBLCurrentSC.CD_SOUS_CATEGORIE);
												}
											...
											if (insertNewValueSousCategorie != null) {
												...
												if (insertNewValueSousCategorie.LB_SOUS_CATEGORIE == null) {
													...
													pstmt_tDBOutput_5.setString(1,
															insertNewValueSousCategorie.LB_SOUS_CATEGORIE);
												}
												...
												if (insertNewValueSousCategorie.CD_CATEGORIE == null) {
													...
													pstmt_tDBOutput_5.setString(2,
															insertNewValueSousCategorie.CD_CATEGORIE);
												}
												...
												if (insertNewValueSousCategorie.LB_NOM_FICHIER == null) {
													...
													pstmt_tDBOutput_5.setString(3,
															insertNewValueSousCategorie.LB_NOM_FICHIER);
												}

												if (insertNewValueSousCategorie.DT_INSERTION != null) {
													pstmt_tDBOutput_5.setTimestamp(4, new java.sql.Timestamp(
															insertNewValueSousCategorie.DT_INSERTION.getTime()));
												} else {
													pstmt_tDBOutput_5.setNull(4, java.sql.Types.TIMESTAMP);
												}

												pstmt_tDBOutput_5.setInt(5,
														insertNewValueSousCategorie.BL_LIGNE_ACTIVE);
												...
												if (insertNewValueSousCategorie.LB_JOB_NAME == null) {
													...
													pstmt_tDBOutput_5.setString(6,
															insertNewValueSousCategorie.LB_JOB_NAME);
												}

												if (insertNewValueSousCategorie.CD_SOUS_CATEGORIE == null) {
													pstmt_tDBOutput_5.setNull(7 + count_tDBOutput_5,
															java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_5.setString(7 + count_tDBOutput_5,
															insertNewValueSousCategorie.CD_SOUS_CATEGORIE);
												}
...
// Start of branch "CategorieManquantes"
										if (CategorieManquantes != null) {
											...
											if (CategorieManquantes.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_6.setString(1, CategorieManquantes.LB_CHEMIN_FICHIER);
											}

											if (CategorieManquantes.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_6.setString(2, CategorieManquantes.LB_NOM_FICHIER);
											}
											...
											if (CategorieManquantes.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_6.setString(4, CategorieManquantes.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_6 > 0) {
												if (CategorieManquantes.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(1,
															CategorieManquantes.LB_MESSAGE_REJET);
												}
												...
												if (CategorieManquantes.LB_NOM_FLUX == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(2,
															CategorieManquantes.LB_NOM_FLUX);
												}

												if (CategorieManquantes.DT_REJET != null) {
													pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(
															CategorieManquantes.DT_REJET.getTime()));
												} else {
												...
												if (CategorieManquantes.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(4,
															CategorieManquantes.LB_JOB_NAME);
												}
												...
												if (CategorieManquantes.LB_CHEMIN_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6,
															CategorieManquantes.LB_CHEMIN_FICHIER);
												}
												...
												if (CategorieManquantes.LB_NOM_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6,
															CategorieManquantes.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6,
														CategorieManquantes.NUM_LIGNE_REJET);
												...
												if (CategorieManquantes.LB_LIGNE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6,
															CategorieManquantes.LB_LIGNE_REJET);
												}
												...
												if (CategorieManquantes.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_6.setString(6,
															CategorieManquantes.LB_NOM_FLUX);
												}

												if (CategorieManquantes.DT_REJET != null) {
													pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(
															CategorieManquantes.DT_REJET.getTime()));
												} else {
												...
												if (CategorieManquantes.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_6.setString(8,
															CategorieManquantes.LB_JOB_NAME);
												}
...
// # Output table : 'insertDuplicateSC'
											insertDuplicateSC_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											insertDuplicateSC_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											insertDuplicateSC_tmp.NUM_LIGNE_REJET = row4.NUM_LIGNE;
											insertDuplicateSC_tmp.LB_LIGNE_REJET = row4.CD_SOUS_CATEGORIE + "|"
													+ row4.LB_SOUS_CATEGORIE + "|" + row4.CD_CATEGORIE;
...
// Start of branch "insertDuplicateSC"
										if (insertDuplicateSC != null) {
											...
											if (insertDuplicateSC.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_2.setString(1, insertDuplicateSC.LB_CHEMIN_FICHIER);
											}

											if (insertDuplicateSC.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(2, insertDuplicateSC.LB_NOM_FICHIER);
											}
											...
											if (insertDuplicateSC.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_2.setString(4, insertDuplicateSC.LB_LIGNE_REJET);
											}

											if (insertDuplicateSC.LB_MESSAGE_REJET == null) {
												pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(5, insertDuplicateSC.LB_MESSAGE_REJET);
											}

											if (insertDuplicateSC.LB_NOM_FLUX == null) {
												pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(6, insertDuplicateSC.LB_NOM_FLUX);
											}

											if (insertDuplicateSC.DT_REJET != null) {
												pstmt_tDBOutput_2.setTimestamp(7,
														new java.sql.Timestamp(insertDuplicateSC.DT_REJET.getTime()));
											} else {
											...
											if (insertDuplicateSC.LB_JOB_NAME == null) {
												...
												pstmt_tDBOutput_2.setString(8, insertDuplicateSC.LB_JOB_NAME);
											}
...
// # Output table : 'rejectSC'
										rejectSC_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILEPATH"));
										rejectSC_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILE"));
										rejectSC_tmp.NUM_LIGNE_REJET = row2.NUM_LIGNE;
										rejectSC_tmp.LB_LIGNE_REJET = row2.CD_SOUS_CATEGORIE + "|"
												+ row2.LB_SOUS_CATEGORIE + "|" + row2.CD_CATEGORIE;
...
// Start of branch "rejectSC"
									if (rejectSC != null) {
										...
										if (rejectSC.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_1.setString(1, rejectSC.LB_CHEMIN_FICHIER);
										}

										if (rejectSC.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, rejectSC.LB_NOM_FICHIER);
										}
										...
										if (rejectSC.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_1.setString(4, rejectSC.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_1 > 0) {
											if (rejectSC.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(1, rejectSC.LB_MESSAGE_REJET);
											}

											if (rejectSC.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_1.setString(2, rejectSC.LB_NOM_FLUX);
											}

											if (rejectSC.DT_REJET != null) {
												pstmtUpdate_tDBOutput_1.setTimestamp(3,
														new java.sql.Timestamp(rejectSC.DT_REJET.getTime()));
											} else {
											...
											if (rejectSC.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(4, rejectSC.LB_JOB_NAME);
											}
											...
											if (rejectSC.LB_CHEMIN_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_1.setString(1, rejectSC.LB_CHEMIN_FICHIER);
											}

											if (rejectSC.LB_NOM_FICHIER == null) {
												pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(2, rejectSC.LB_NOM_FICHIER);
											}
											...
											if (rejectSC.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_1.setString(4, rejectSC.LB_LIGNE_REJET);
											}

											if (rejectSC.LB_MESSAGE_REJET == null) {
												pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(5, rejectSC.LB_MESSAGE_REJET);
											}

											if (rejectSC.LB_NOM_FLUX == null) {
												pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(6, rejectSC.LB_NOM_FLUX);
											}
											...
											if (rejectSC.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_1.setString(8, rejectSC.LB_JOB_NAME);
											}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_4 - inputs:(sousCategorie,row6)
				// outputs:(insertSousCategory,updateBLCurrentSC,insertNewValueSousCategorie)
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"" + context.schema_ods
						...
						+ "\".\"ODS_SOUS_CATEGORIE\".\"LB_SOUS_CATEGORIE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\".\"CD_CATEGORIE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\".\"LB_NOM_FICHIER\", \n  \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\".\"DT_INSERTION\", \n  \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\".\"BL_LIGNE_ACTIVE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\".\"LB_JOB_NAME\"\nFROM \"" + context.schema_ods
						+ "\".\"ODS_SOUS_CATEGORIE\"";
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_5 - inputs:(row5,row7)
				// outputs:(sousCategorie,CategorieManquantes)
				...
				String dbquery_tDBInput_2 = "SELECT \n  \"" + context.schema_ods
						...
						+ "\".\"ODS_CATEGORIE\".\"LB_CATEGORIE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CATEGORIE\".\"LB_NOM_FICHIER\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CATEGORIE\".\"DT_INSERTION\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CATEGORIE\".\"BL_LIGNE_ACTIVE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CATEGORIE\".\"LB_JOB_NAME\"\nFROM \"" + context.schema_ods + "\".\"ODS_CATEGORIE\"";
...
/************************************************************************************************
 * 390100 characters generated by Talend Open Studio for Data Integration on the
 * 20 août 2024 à 11:27:28 GMT
 ************************************************************************************************/