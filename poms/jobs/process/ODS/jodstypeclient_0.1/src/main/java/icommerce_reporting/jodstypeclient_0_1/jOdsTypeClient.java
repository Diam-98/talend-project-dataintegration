...
public class jOdsTypeClient implements TalendJob {
	...
	public static class insertNewValueTypeClientStruct
			implements routines.system.IPersistableRow<insertNewValueTypeClientStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsTypeClient = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClient = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String update_tDBOutput_7 = "UPDATE \"" + tableName_tDBOutput_7
						+ "\" SET \"LB_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_TYPE_CLIENT\" = ?";
...
// ###############################
				...
				java.sql.PreparedStatement pstmt_tDBOutput_9 = conn_tDBOutput_9
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_9
								+ "\" WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?");
				...
				String update_tDBOutput_9 = "UPDATE \"" + tableName_tDBOutput_9
						+ "\" SET \"LB_MESSAGE_REJET\" = ?,\"LB_NOM_FLUX\" = ?,\"DT_REJET\" = ?,\"LB_JOB_NAME\" = ? WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?";
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								((String) globalMap.get("tFileList_2_CURRENT_FILEPATH")), context.encoding,
...
// Start of branch "row1"
								if (row1 != null) {
									...
									if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
										...
										row9.CD_TYPE_CLIENT = row1.CD_TYPE_CLIENT;
										row9.LB_TYPE_CLIENT = row1.LB_TYPE_CLIENT;
										row9.NUM_LIGNE = row1.NUM_LIGNE;
										...
										row12.CD_TYPE_CLIENT = row1.CD_TYPE_CLIENT;
										row12.LB_TYPE_CLIENT = row1.LB_TYPE_CLIENT;
										row12.NUM_LIGNE = row1.NUM_LIGNE;
...
// Start of branch "row9"
									if (row9 != null) {
										...
										if (tHash_Lookup_row10 != null
											...
											// 'row10' and it contains more one result from keys : row10.CD_TYPE_CLIENT
											// = '" + row10HashKey.CD_TYPE_CLIENT + "'");
										} // G 071
...
// # Output table : 'insertNewValueTypeClient'
												...
												insertNewValueTypeClient_tmp.LB_NOM_FICHIER = ((String) globalMap
...
// # Filter conditions 
											if (rejectedInnerJoin_tMap_6) {
												...
												insertTypeClient_tmp.LB_NOM_FICHIER = ((String) globalMap
														.get("tFileList_2_CURRENT_FILE"));
...
// Start of branch "updateTCBLCurrent"
										if (updateTCBLCurrent != null) {
											...
											if (updateTCBLCurrent.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_7.setString(5, updateTCBLCurrent.LB_JOB_NAME);
											}
											...
											if (updateTCBLCurrent.CD_TYPE_CLIENT == null) {
												...
												pstmtUpdate_tDBOutput_7.setString(6 + count_tDBOutput_7,
														updateTCBLCurrent.CD_TYPE_CLIENT);
											}
												...
												if (updateFlag_tDBOutput_7 == 0) {
													...
													if (updateTCBLCurrent.LB_TYPE_CLIENT == null) {
														...
														pstmtInsert_tDBOutput_7.setString(2,
																updateTCBLCurrent.LB_TYPE_CLIENT);
													}

													if (updateTCBLCurrent.LB_NOM_FICHIER == null) {
														pstmtInsert_tDBOutput_7.setNull(3, java.sql.Types.VARCHAR);
													} else {
														pstmtInsert_tDBOutput_7.setString(3,
																updateTCBLCurrent.LB_NOM_FICHIER);
													}

													if (updateTCBLCurrent.DT_INSERTION != null) {
														pstmtInsert_tDBOutput_7.setTimestamp(4, new java.sql.Timestamp(
																updateTCBLCurrent.DT_INSERTION.getTime()));
													} else {
														pstmtInsert_tDBOutput_7.setNull(4, java.sql.Types.TIMESTAMP);
													}

													pstmtInsert_tDBOutput_7.setInt(5,
															updateTCBLCurrent.BL_LIGNE_ACTIVE);

													if (updateTCBLCurrent.LB_JOB_NAME == null) {
														pstmtInsert_tDBOutput_7.setNull(6, java.sql.Types.VARCHAR);
													} else {
														pstmtInsert_tDBOutput_7.setString(6,
																updateTCBLCurrent.LB_JOB_NAME);
													}
...
// Start of branch "insertTypeClient"
										if (insertTypeClient != null) {
											...
											if (insertTypeClient.LB_JOB_NAME == null) {
												...
												pstmt_tDBOutput_6.setString(6, insertTypeClient.LB_JOB_NAME);
											}
...
// Start of branch "insertNewValueTypeClient"
										if (insertNewValueTypeClient != null) {
											...
											if (insertNewValueTypeClient.CD_TYPE_CLIENT == null) {
												...
												pstmt_tDBOutput_8.setString(1, insertNewValueTypeClient.CD_TYPE_CLIENT);
											}

											if (insertNewValueTypeClient.LB_TYPE_CLIENT == null) {
												pstmt_tDBOutput_8.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_8.setString(2, insertNewValueTypeClient.LB_TYPE_CLIENT);
											}

											if (insertNewValueTypeClient.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_8.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_8.setString(3, insertNewValueTypeClient.LB_NOM_FICHIER);
											}

											if (insertNewValueTypeClient.DT_INSERTION != null) {
												pstmt_tDBOutput_8.setTimestamp(4, new java.sql.Timestamp(
														insertNewValueTypeClient.DT_INSERTION.getTime()));
											} else {
											...
											if (insertNewValueTypeClient.LB_JOB_NAME == null) {
												...
												pstmt_tDBOutput_8.setString(6, insertNewValueTypeClient.LB_JOB_NAME);
											}
											...
											if ((batchSize_tDBOutput_8 > 0)
												...
												try {
													...
													globalMap.put("tDBOutput_8_ERROR_MESSAGE",
...
// # Output table : 'insertTCDuplicates'
											insertTCDuplicates_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_2_CURRENT_FILEPATH"));
											insertTCDuplicates_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_2_CURRENT_FILE"));
											insertTCDuplicates_tmp.NUM_LIGNE_REJET = row12.NUM_LIGNE;
											insertTCDuplicates_tmp.LB_LIGNE_REJET = row12.CD_TYPE_CLIENT + "|"
													+ row12.LB_TYPE_CLIENT;
...
// Start of branch "insertTCDuplicates"
										if (insertTCDuplicates != null) {
											...
											if (insertTCDuplicates.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_10.setString(1, insertTCDuplicates.LB_CHEMIN_FICHIER);
											}

											if (insertTCDuplicates.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_10.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_10.setString(2, insertTCDuplicates.LB_NOM_FICHIER);
											}
											...
											if (insertTCDuplicates.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_10.setString(4, insertTCDuplicates.LB_LIGNE_REJET);
											}

											int checkCount_tDBOutput_10 = -1;
											try (java.sql.ResultSet rs_tDBOutput_10 = pstmt_tDBOutput_10
													.executeQuery()) {
											...
											if (checkCount_tDBOutput_10 > 0) {
												if (insertTCDuplicates.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_10.setString(1,
															insertTCDuplicates.LB_MESSAGE_REJET);
												}

												if (insertTCDuplicates.LB_NOM_FLUX == null) {
													pstmtUpdate_tDBOutput_10.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_10.setString(2,
															insertTCDuplicates.LB_NOM_FLUX);
												}

												if (insertTCDuplicates.DT_REJET != null) {
													pstmtUpdate_tDBOutput_10.setTimestamp(3, new java.sql.Timestamp(
															insertTCDuplicates.DT_REJET.getTime()));
												} else {
												...
												if (insertTCDuplicates.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_10.setString(4,
															insertTCDuplicates.LB_JOB_NAME);
												}
												...
												if (insertTCDuplicates.LB_CHEMIN_FICHIER == null) {
													...
													pstmtUpdate_tDBOutput_10.setString(5 + count_tDBOutput_10,
															insertTCDuplicates.LB_CHEMIN_FICHIER);
												}

												if (insertTCDuplicates.LB_NOM_FICHIER == null) {
													pstmtUpdate_tDBOutput_10.setNull(6 + count_tDBOutput_10,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_10.setString(6 + count_tDBOutput_10,
															insertTCDuplicates.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_10.setInt(7 + count_tDBOutput_10,
														insertTCDuplicates.NUM_LIGNE_REJET);
												...
												if (insertTCDuplicates.LB_LIGNE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_10.setString(8 + count_tDBOutput_10,
															insertTCDuplicates.LB_LIGNE_REJET);
												}

												try {

													int processedCount_tDBOutput_10 = pstmtUpdate_tDBOutput_10
															.executeUpdate();
												...
												if (insertTCDuplicates.LB_CHEMIN_FICHIER == null) {
													...
													pstmtInsert_tDBOutput_10.setString(1,
															insertTCDuplicates.LB_CHEMIN_FICHIER);
												}
												...
												if (insertTCDuplicates.LB_NOM_FICHIER == null) {
													...
													pstmtInsert_tDBOutput_10.setString(2,
															insertTCDuplicates.LB_NOM_FICHIER);
												}
												...
												if (insertTCDuplicates.LB_LIGNE_REJET == null) {
													...
													pstmtInsert_tDBOutput_10.setString(4,
															insertTCDuplicates.LB_LIGNE_REJET);
												}
												...
												if (insertTCDuplicates.LB_MESSAGE_REJET == null) {
													...
													pstmtInsert_tDBOutput_10.setString(5,
															insertTCDuplicates.LB_MESSAGE_REJET);
												}
												...
												if (insertTCDuplicates.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_10.setString(6,
															insertTCDuplicates.LB_NOM_FLUX);
												}

												if (insertTCDuplicates.DT_REJET != null) {
													pstmtInsert_tDBOutput_10.setTimestamp(7, new java.sql.Timestamp(
															insertTCDuplicates.DT_REJET.getTime()));
												} else {
												...
												if (insertTCDuplicates.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_10.setString(8,
															insertTCDuplicates.LB_JOB_NAME);
												}

												try {

													int processedCount_tDBOutput_10 = pstmtInsert_tDBOutput_10
															.executeUpdate();
...
// # Output table : 'insertTCReject'
										insertTCReject_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_2_CURRENT_FILEPATH"));
										insertTCReject_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_2_CURRENT_FILE"));
										insertTCReject_tmp.NUM_LIGNE_REJET = row2.NUM_LIGNE;
										insertTCReject_tmp.LB_LIGNE_REJET = row2.CD_TYPE_CLIENT + "|"
												+ row2.LB_TYPE_CLIENT;
...
// Start of branch "insertTCReject"
									if (insertTCReject != null) {
										...
										if (insertTCReject.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_9.setString(1, insertTCReject.LB_CHEMIN_FICHIER);
										}

										if (insertTCReject.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_9.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_9.setString(2, insertTCReject.LB_NOM_FICHIER);
										}
										...
										if (insertTCReject.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_9.setString(4, insertTCReject.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_9 > 0) {
											if (insertTCReject.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_9.setString(1, insertTCReject.LB_MESSAGE_REJET);
											}

											if (insertTCReject.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_9.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_9.setString(2, insertTCReject.LB_NOM_FLUX);
											}

											if (insertTCReject.DT_REJET != null) {
												pstmtUpdate_tDBOutput_9.setTimestamp(3,
														new java.sql.Timestamp(insertTCReject.DT_REJET.getTime()));
											} else {
											...
											if (insertTCReject.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_9.setString(4, insertTCReject.LB_JOB_NAME);
											}

											if (insertTCReject.LB_CHEMIN_FICHIER == null) {
												pstmtUpdate_tDBOutput_9.setNull(5 + count_tDBOutput_9,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_9.setString(5 + count_tDBOutput_9,
														insertTCReject.LB_CHEMIN_FICHIER);
											}

											if (insertTCReject.LB_NOM_FICHIER == null) {
												pstmtUpdate_tDBOutput_9.setNull(6 + count_tDBOutput_9,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_9.setString(6 + count_tDBOutput_9,
														insertTCReject.LB_NOM_FICHIER);
											}

											pstmtUpdate_tDBOutput_9.setInt(7 + count_tDBOutput_9,
													insertTCReject.NUM_LIGNE_REJET);

											if (insertTCReject.LB_LIGNE_REJET == null) {
												pstmtUpdate_tDBOutput_9.setNull(8 + count_tDBOutput_9,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_9.setString(8 + count_tDBOutput_9,
														insertTCReject.LB_LIGNE_REJET);
											}

											try {

												int processedCount_tDBOutput_9 = pstmtUpdate_tDBOutput_9
														.executeUpdate();
											...
											if (insertTCReject.LB_CHEMIN_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_9.setString(1, insertTCReject.LB_CHEMIN_FICHIER);
											}

											if (insertTCReject.LB_NOM_FICHIER == null) {
												pstmtInsert_tDBOutput_9.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_9.setString(2, insertTCReject.LB_NOM_FICHIER);
											}
											...
											if (insertTCReject.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_9.setString(4, insertTCReject.LB_LIGNE_REJET);
											}

											if (insertTCReject.LB_MESSAGE_REJET == null) {
												pstmtInsert_tDBOutput_9.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_9.setString(5, insertTCReject.LB_MESSAGE_REJET);
											}

											if (insertTCReject.LB_NOM_FLUX == null) {
												pstmtInsert_tDBOutput_9.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_9.setString(6, insertTCReject.LB_NOM_FLUX);
											}

											if (insertTCReject.DT_REJET != null) {
												pstmtInsert_tDBOutput_9.setTimestamp(7,
														new java.sql.Timestamp(insertTCReject.DT_REJET.getTime()));
											} else {
											...
											if (insertTCReject.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_9.setString(8, insertTCReject.LB_JOB_NAME);
											}

											try {

												int processedCount_tDBOutput_9 = pstmtInsert_tDBOutput_9
														.executeUpdate();
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_6 - inputs:(row9,row10)
				// outputs:(updateTCBLCurrent,insertTypeClient,insertNewValueTypeClient)
...
/************************************************************************************************
 * 317057 characters generated by Talend Open Studio for Data Integration on the
 * 16 août 2024 à 13:19:34 GMT
 ************************************************************************************************/