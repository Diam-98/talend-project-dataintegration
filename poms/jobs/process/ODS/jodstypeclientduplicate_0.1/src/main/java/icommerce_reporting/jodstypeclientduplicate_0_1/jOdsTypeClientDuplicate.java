...
package icommerce_reporting.jodstypeclientduplicate_0_1;
...
/**
 * Job: jOdsTypeClientDuplicate Purpose: Aliment la table ODS.<br>
 ...
 * @status
 */
public class jOdsTypeClientDuplicate implements TalendJob {
	...
	private final String jobName = "jOdsTypeClientDuplicate";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					jOdsTypeClientDuplicate.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jOdsTypeClientDuplicate.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate.length) {
					if (length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate.length == 0) {
						commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate = new byte[1024];
					} else {
						commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate, 0, length);
				strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate, 0, length);
				strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ICOMMERCE_REPORTING_jOdsTypeClientDuplicate) {
...
//tJava_1
	...
	public static void main(String[] args) {
		final jOdsTypeClientDuplicate jOdsTypeClientDuplicateClass = new jOdsTypeClientDuplicate();

		int exitCode = jOdsTypeClientDuplicateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jOdsTypeClientDuplicate.class.getClassLoader().getResourceAsStream(
					"icommerce_reporting/jodstypeclientduplicate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jOdsTypeClientDuplicate.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : jOdsTypeClientDuplicate");
		}
...
/************************************************************************************************
 * 106939 characters generated by Talend Open Studio for Data Integration on the
 * 16 août 2024 à 12:52:48 GMT
 ************************************************************************************************/