...
/**
 * Job: jDWHProduit Purpose: Alimentation de le table PRODUIT_DWH<br>
 * Description: Permet d'alimenter la table PRODUIT_DWH <br>
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ID_DIM_PRODUIT\",\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"DT_MISE_A_JOUR\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
!produits.NOM_PRODUIT.equals(row4.NOM_PRODUIT) || produits.PRIX_ACHAT_PRODUIT.compareTo(row4.PRIX_ACHAT_PRODUIT ) != 0 || produits.PRIX_VENTE_PRODUIT.compareTo(row4.PRIX_VENTE_PRODUIT) != 0 || 
...
insertNewProduit_tmp.ID_DIM_PRODUIT = 0;
...
if(updateProduit != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, updateProduit.ID_DIM_PRODUIT);

                    if(updateProduit.CD_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, updateProduit.CD_PRODUIT);
}

                    if(updateProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, updateProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_2.setBigDecimal(4, updateProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_2.setBigDecimal(5, updateProduit.PRIX_VENTE_PRODUIT);

                    if(updateProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, updateProduit.CD_SOUS_CATEGORIE);
}

                    if(updateProduit.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, updateProduit.LB_SOUS_CATEGORIE);
}

                    if(updateProduit.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, updateProduit.CD_CATEGORIE);
}

                    if(updateProduit.LB_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, updateProduit.LB_CATEGORIE);
}

                    if(updateProduit.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(10, new java.sql.Timestamp(updateProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(updateProduit.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(updateProduit.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(12, updateProduit.BL_LIGNE_ACTIVE);

                    if(updateProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(13, updateProduit.LB_JOB_NAME);
}
...
if(insertNewProduit != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    pstmt_tDBOutput_3.setInt(1, insertNewProduit.ID_DIM_PRODUIT);

                    if(insertNewProduit.CD_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewProduit.CD_PRODUIT);
}

                    if(insertNewProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertNewProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_3.setBigDecimal(4, insertNewProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_3.setBigDecimal(5, insertNewProduit.PRIX_VENTE_PRODUIT);

                    if(insertNewProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertNewProduit.CD_SOUS_CATEGORIE);
}

                    if(insertNewProduit.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, insertNewProduit.LB_SOUS_CATEGORIE);
}

                    if(insertNewProduit.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, insertNewProduit.CD_CATEGORIE);
}

                    if(insertNewProduit.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, insertNewProduit.LB_CATEGORIE);
}

                    if(insertNewProduit.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(insertNewProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(insertNewProduit.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_3.setTimestamp(11, new java.sql.Timestamp(insertNewProduit.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_3.setNull(11, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(12, insertNewProduit.BL_LIGNE_ACTIVE);

                    if(insertNewProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(13, insertNewProduit.LB_JOB_NAME);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(produits)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(produits,row4) outputs:(insertProduit,updateProduit,insertNewProduit)
...
/************************************************************************************************
 *     293371 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 août 2024 à 11:49:43 GMT
 ************************************************************************************************/