...
insertCategory_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE")) ;
...
} else {pstmt_tDBOutput_1.setString(1, insertCategory.CD_CATEGORIE);
}

                    if(insertCategory.LB_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertCategory.LB_CATEGORIE);
}

                    if(insertCategory.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insertCategory.LB_NOM_FICHIER);
}

                    if(insertCategory.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(insertCategory.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(6, insertCategory.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_2.setString(1, updateBLCurrent.LB_CATEGORIE);
}

                    if(updateBLCurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, updateBLCurrent.LB_NOM_FICHIER);
}

                    if(updateBLCurrent.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(updateBLCurrent.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setString(5, updateBLCurrent.LB_JOB_NAME);
}

                    if(updateBLCurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6 + count_tDBOutput_2, updateBLCurrent.CD_CATEGORIE);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(insertCategory,updateBLCurrent,insertNewValueCategorie)
...
/************************************************************************************************
 *     315564 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 août 2024 à 11:49:37 GMT
 ************************************************************************************************/