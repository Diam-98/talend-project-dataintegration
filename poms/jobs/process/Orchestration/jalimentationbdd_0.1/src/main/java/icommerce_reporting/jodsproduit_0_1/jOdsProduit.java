...
/**
 * Job: jOdsProduit Purpose: Alimenter la table ods produit<br>
 * Description: Permet d'alimenter la table ODS Produit <br>
...
public static class insertRejectProdStruct implements routines.system.IPersistableRow<insertRejectProdStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertRejectProdStruct other = (insertRejectProdStruct) obj;
	...
	public void copyDataTo(insertRejectProdStruct other) {
	...
	public void copyKeysDataTo(insertRejectProdStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertRejectProdStruct other) {
...
public static class insertProdDuplicatesStruct implements routines.system.IPersistableRow<insertProdDuplicatesStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertProdDuplicatesStruct other = (insertProdDuplicatesStruct) obj;
	...
	public void copyDataTo(insertProdDuplicatesStruct other) {
	...
	public void copyKeysDataTo(insertProdDuplicatesStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertProdDuplicatesStruct other) {
...
public static class UpdateBLCurrentProduitStruct implements routines.system.IPersistableRow<UpdateBLCurrentProduitStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final UpdateBLCurrentProduitStruct other = (UpdateBLCurrentProduitStruct) obj;
	...
	public void copyDataTo(UpdateBLCurrentProduitStruct other) {
	...
	public void copyKeysDataTo(UpdateBLCurrentProduitStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(UpdateBLCurrentProduitStruct other) {
...
public static class produitCleanStruct implements routines.system.IPersistableRow<produitCleanStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsProduit = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(produitCleanStruct other) {
...
produitCleanStruct produitClean = new produitCleanStruct();
insertProduitStruct insertProduit = new insertProduitStruct();
UpdateBLCurrentProduitStruct UpdateBLCurrentProduit = new UpdateBLCurrentProduitStruct();
...
insertProdDuplicatesStruct insertProdDuplicates = new insertProdDuplicatesStruct();
row2Struct row2 = new row2Struct();
insertRejectProdStruct insertRejectProd = new insertRejectProdStruct();
 ...
 */
	...
	currentComponent="tDBOutput_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"UpdateBLCurrentProduit");
					}
 ...
 */
	...
	currentComponent="tMap_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"produitClean");
					}
...
UpdateBLCurrentProduitStruct UpdateBLCurrentProduit_tmp = new UpdateBLCurrentProduitStruct();
...
// ###############################
// # Outputs initialization
produitCleanStruct produitClean_tmp = new produitCleanStruct();
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertProdDuplicates");
					}
...
// ###############################
// # Outputs initialization
insertProdDuplicatesStruct insertProdDuplicates_tmp = new insertProdDuplicatesStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertRejectProd");
					}
...
// ###############################
// # Outputs initialization
insertRejectProdStruct insertRejectProd_tmp = new insertRejectProdStruct();
// ###############################
...
!produit.CD_PRODUIT.isEmpty() &&
!produit.CD_SOUS_CATEGORIE.isEmpty() &&
!produit.NOM_PRODUIT.isEmpty() &&
...
produit.PRIX_VENTE_PRODUIT != null
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row3 == null){ 
               ...
               row3.CD_PRODUIT = produit.CD_PRODUIT;
               row3.NOM_PRODUIT = produit.NOM_PRODUIT;
               row3.PRIX_ACHAT_PRODUIT = produit.PRIX_ACHAT_PRODUIT;
               row3.PRIX_VENTE_PRODUIT = produit.PRIX_VENTE_PRODUIT;
               row3.CD_SOUS_CATEGORIE = produit.CD_SOUS_CATEGORIE;
               row3.NUM_LIGNE = produit.NUM_LIGNE;    
...
row4 = null;			row5 = null;			
if(row3.CD_PRODUIT == null){
	finder_tUniqRow_1.CD_PRODUIT = null;
}else{
	finder_tUniqRow_1.CD_PRODUIT = row3.CD_PRODUIT.toLowerCase();
}	
...
if(row3.CD_PRODUIT == null){
	...
	new_tUniqRow_1.CD_PRODUIT = row3.CD_PRODUIT.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
	row5 = new row5Struct();
}row5.CD_PRODUIT = row3.CD_PRODUIT;			row5.NOM_PRODUIT = row3.NOM_PRODUIT;			row5.PRIX_ACHAT_PRODUIT = row3.PRIX_ACHAT_PRODUIT;			row5.PRIX_VENTE_PRODUIT = row3.PRIX_VENTE_PRODUIT;			row5.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE;			row5.NUM_LIGNE = row3.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row4 == null){ 
	
	row4 = new row4Struct();
}				row4.CD_PRODUIT = row3.CD_PRODUIT;			row4.NOM_PRODUIT = row3.NOM_PRODUIT;			row4.PRIX_ACHAT_PRODUIT = row3.PRIX_ACHAT_PRODUIT;			row4.PRIX_VENTE_PRODUIT = row3.PRIX_VENTE_PRODUIT;			row4.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE;			row4.NUM_LIGNE = row3.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		    ...
                        		    		    row6HashKey.CD_SOUS_CATEGORIE = row5.CD_SOUS_CATEGORIE ;
...
// # Output table : 'produitClean'
produitClean_tmp.CD_PRODUIT = row5.CD_PRODUIT ;
produitClean_tmp.NOM_PRODUIT = row5.NOM_PRODUIT ;
produitClean_tmp.PRIX_ACHAT_PRODUIT = row5.PRIX_ACHAT_PRODUIT ;
produitClean_tmp.PRIX_VENTE_PRODUIT = row5.PRIX_VENTE_PRODUIT ;
produitClean_tmp.CD_SOUS_CATEGORIE = row5.CD_SOUS_CATEGORIE ;
produitClean_tmp.NUM_LIGNE = row5.NUM_LIGNE ;
produitClean = produitClean_tmp;
...
sousCategorieManquant_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE ;
sousCategorieManquant_tmp.LB_LIGNE_REJET = row5.CD_PRODUIT +"|"+ row5.NOM_PRODUIT +"|"+ row5.PRIX_ACHAT_PRODUIT +"|"+ row5.PRIX_VENTE_PRODUIT +"|"+ row5.CD_SOUS_CATEGORIE ;
sousCategorieManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> la sous categorie "+row5.CD_SOUS_CATEGORIE + " n'existe pas dans la table ODS_SOUS_CATEGORIE" ;
 ...
 */
// Start of branch "produitClean"
if(produitClean != null) { 
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_PRODUIT = produitClean.CD_PRODUIT ;
...
UpdateBLCurrentProduit = null;
insertNewValueProduit = null;
insertProduit = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'UpdateBLCurrentProduit'
// # Filter conditions 
if( 

!produitClean.NOM_PRODUIT.equals(row7.NOM_PRODUIT) || 
!produitClean.CD_SOUS_CATEGORIE.equals(row7.CD_SOUS_CATEGORIE ) || 
produitClean.PRIX_ACHAT_PRODUIT.compareTo(row7.PRIX_ACHAT_PRODUIT) != 0 ||  
produitClean.PRIX_VENTE_PRODUIT.compareTo(row7.PRIX_VENTE_PRODUIT ) != 0

 ) {
UpdateBLCurrentProduit_tmp.CD_PRODUIT = produitClean.CD_PRODUIT ;
UpdateBLCurrentProduit_tmp.NOM_PRODUIT = null;
UpdateBLCurrentProduit_tmp.PRIX_ACHAT_PRODUIT = null;
UpdateBLCurrentProduit_tmp.PRIX_VENTE_PRODUIT = null;
UpdateBLCurrentProduit_tmp.CD_SOUS_CATEGORIE = null;
UpdateBLCurrentProduit_tmp.LB_NOM_FICHIER = null;
UpdateBLCurrentProduit_tmp.DT_INSERTION = null;
UpdateBLCurrentProduit_tmp.BL_LIGNE_ACTIVE = 0;
UpdateBLCurrentProduit_tmp.LB_JOB_NAME = null;
UpdateBLCurrentProduit = UpdateBLCurrentProduit_tmp;
} // closing filter/reject

// # Output table : 'insertNewValueProduit'
insertNewValueProduit_tmp.CD_PRODUIT = produitClean.CD_PRODUIT ;
insertNewValueProduit_tmp.NOM_PRODUIT = produitClean.NOM_PRODUIT ;
insertNewValueProduit_tmp.PRIX_ACHAT_PRODUIT = produitClean.PRIX_ACHAT_PRODUIT ;
insertNewValueProduit_tmp.PRIX_VENTE_PRODUIT = produitClean.PRIX_VENTE_PRODUIT ;
insertNewValueProduit_tmp.CD_SOUS_CATEGORIE = produitClean.CD_SOUS_CATEGORIE ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertProduit_tmp.CD_PRODUIT = produitClean.CD_PRODUIT ;
insertProduit_tmp.NOM_PRODUIT = produitClean.NOM_PRODUIT ;
insertProduit_tmp.PRIX_ACHAT_PRODUIT = produitClean.PRIX_ACHAT_PRODUIT ;
insertProduit_tmp.PRIX_VENTE_PRODUIT = produitClean.PRIX_VENTE_PRODUIT ;
insertProduit_tmp.CD_SOUS_CATEGORIE = produitClean.CD_SOUS_CATEGORIE ;
...
} else {pstmt_tDBOutput_4.setString(1, insertProduit.CD_PRODUIT);
}

                    if(insertProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, insertProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_4.setBigDecimal(3, insertProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_4.setBigDecimal(4, insertProduit.PRIX_VENTE_PRODUIT);

                    if(insertProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, insertProduit.CD_SOUS_CATEGORIE);
}

                    if(insertProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, insertProduit.LB_NOM_FICHIER);
}

                    if(insertProduit.DT_INSERTION != null) {
pstmt_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(insertProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_4.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_4.setInt(8, insertProduit.BL_LIGNE_ACTIVE);

                    if(insertProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_4.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(9, insertProduit.LB_JOB_NAME);
}
...
// Start of branch "UpdateBLCurrentProduit"
if(UpdateBLCurrentProduit != null) { 
	...
	currentComponent="tDBOutput_5";
        ...
        whetherReject_tDBOutput_5 = false;
                    if(UpdateBLCurrentProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(1, UpdateBLCurrentProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_5.setBigDecimal(2, UpdateBLCurrentProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_5.setBigDecimal(3, UpdateBLCurrentProduit.PRIX_VENTE_PRODUIT);

                    if(UpdateBLCurrentProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(4, UpdateBLCurrentProduit.CD_SOUS_CATEGORIE);
}

                    if(UpdateBLCurrentProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(5, UpdateBLCurrentProduit.LB_NOM_FICHIER);
}

                    if(UpdateBLCurrentProduit.DT_INSERTION != null) {
pstmt_tDBOutput_5.setTimestamp(6, new java.sql.Timestamp(UpdateBLCurrentProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_5.setInt(7, UpdateBLCurrentProduit.BL_LIGNE_ACTIVE);

                    if(UpdateBLCurrentProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(8, UpdateBLCurrentProduit.LB_JOB_NAME);
}

                    if(UpdateBLCurrentProduit.CD_PRODUIT == null) {
pstmt_tDBOutput_5.setNull(9 + count_tDBOutput_5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(9 + count_tDBOutput_5, UpdateBLCurrentProduit.CD_PRODUIT);
}
...
} // End of branch "UpdateBLCurrentProduit"
...
} else {pstmt_tDBOutput_3.setString(1, sousCategorieManquant.LB_CHEMIN_FICHIER);
}

                    if(sousCategorieManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, sousCategorieManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_3.setInt(3, sousCategorieManquant.NUM_LIGNE_REJET);

                    if(sousCategorieManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, sousCategorieManquant.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_3.setString(1, sousCategorieManquant.LB_MESSAGE_REJET);
}

                        if(sousCategorieManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, sousCategorieManquant.LB_NOM_FLUX);
}

                        if(sousCategorieManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(sousCategorieManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_3.setString(4, sousCategorieManquant.LB_JOB_NAME);
}

                        if(sousCategorieManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5 + count_tDBOutput_3, sousCategorieManquant.LB_CHEMIN_FICHIER);
}

                        if(sousCategorieManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3, sousCategorieManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_3.setInt(7 + count_tDBOutput_3, sousCategorieManquant.NUM_LIGNE_REJET);

                        if(sousCategorieManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3, sousCategorieManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, sousCategorieManquant.LB_CHEMIN_FICHIER);
}

                        if(sousCategorieManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, sousCategorieManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_3.setInt(3, sousCategorieManquant.NUM_LIGNE_REJET);

                        if(sousCategorieManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, sousCategorieManquant.LB_LIGNE_REJET);
}

                        if(sousCategorieManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, sousCategorieManquant.LB_MESSAGE_REJET);
}

                        if(sousCategorieManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, sousCategorieManquant.LB_NOM_FLUX);
}

                        if(sousCategorieManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(sousCategorieManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(8, sousCategorieManquant.LB_JOB_NAME);
}
...
insertProdDuplicates = null;


// # Output table : 'insertProdDuplicates'
insertProdDuplicates_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
insertProdDuplicates_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertProdDuplicates_tmp.NUM_LIGNE_REJET = row4.NUM_LIGNE ;
insertProdDuplicates_tmp.LB_LIGNE_REJET = row4.CD_PRODUIT +"|"+ row4.NOM_PRODUIT +"|"+ row4.PRIX_ACHAT_PRODUIT +"|"+ row4.PRIX_VENTE_PRODUIT +"|"+ row4.CD_SOUS_CATEGORIE ;
insertProdDuplicates_tmp.LB_MESSAGE_REJET = "Lignes doubles";
insertProdDuplicates_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
insertProdDuplicates_tmp.DT_REJET = TalendDate.getCurrentDate();
insertProdDuplicates_tmp.LB_JOB_NAME = jobName;
insertProdDuplicates = insertProdDuplicates_tmp;
// ###############################
 ...
 */
// Start of branch "insertProdDuplicates"
if(insertProdDuplicates != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(insertProdDuplicates.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, insertProdDuplicates.LB_CHEMIN_FICHIER);
}

                    if(insertProdDuplicates.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertProdDuplicates.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_2.setInt(3, insertProdDuplicates.NUM_LIGNE_REJET);

                    if(insertProdDuplicates.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertProdDuplicates.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_2 > 0) {
                        if(insertProdDuplicates.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(1, insertProdDuplicates.LB_MESSAGE_REJET);
}

                        if(insertProdDuplicates.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, insertProdDuplicates.LB_NOM_FLUX);
}

                        if(insertProdDuplicates.DT_REJET != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(insertProdDuplicates.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(insertProdDuplicates.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(4, insertProdDuplicates.LB_JOB_NAME);
}

                        if(insertProdDuplicates.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2, insertProdDuplicates.LB_CHEMIN_FICHIER);
}

                        if(insertProdDuplicates.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, insertProdDuplicates.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, insertProdDuplicates.NUM_LIGNE_REJET);

                        if(insertProdDuplicates.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(8 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2, insertProdDuplicates.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, insertProdDuplicates.LB_CHEMIN_FICHIER);
}

                        if(insertProdDuplicates.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, insertProdDuplicates.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_2.setInt(3, insertProdDuplicates.NUM_LIGNE_REJET);

                        if(insertProdDuplicates.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, insertProdDuplicates.LB_LIGNE_REJET);
}

                        if(insertProdDuplicates.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, insertProdDuplicates.LB_MESSAGE_REJET);
}

                        if(insertProdDuplicates.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, insertProdDuplicates.LB_NOM_FLUX);
}

                        if(insertProdDuplicates.DT_REJET != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(insertProdDuplicates.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_2.setString(8, insertProdDuplicates.LB_JOB_NAME);
}
...
} // End of branch "insertProdDuplicates"
...
insertRejectProd = null;


// # Output table : 'insertRejectProd'
insertRejectProd_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
insertRejectProd_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertRejectProd_tmp.NUM_LIGNE_REJET = row2.NUM_LIGNE ;
insertRejectProd_tmp.LB_LIGNE_REJET = row2.CD_PRODUIT +"|"+  row2.NOM_PRODUIT +"|"+ row2.PRIX_ACHAT_PRODUIT +"|"+ row2.PRIX_VENTE_PRODUIT +"|"+ row2.CD_SOUS_CATEGORIE ;
insertRejectProd_tmp.LB_MESSAGE_REJET = row2.errorMessage ;
insertRejectProd_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
insertRejectProd_tmp.DT_REJET = TalendDate.getCurrentDate();
insertRejectProd_tmp.LB_JOB_NAME = jobName;
insertRejectProd = insertRejectProd_tmp;
// ###############################
 ...
 */
// Start of branch "insertRejectProd"
if(insertRejectProd != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insertRejectProd.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insertRejectProd.LB_CHEMIN_FICHIER);
}

                    if(insertRejectProd.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertRejectProd.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, insertRejectProd.NUM_LIGNE_REJET);

                    if(insertRejectProd.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, insertRejectProd.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertRejectProd.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertRejectProd.LB_MESSAGE_REJET);
}

                        if(insertRejectProd.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, insertRejectProd.LB_NOM_FLUX);
}

                        if(insertRejectProd.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(insertRejectProd.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(insertRejectProd.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, insertRejectProd.LB_JOB_NAME);
}

                        if(insertRejectProd.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, insertRejectProd.LB_CHEMIN_FICHIER);
}

                        if(insertRejectProd.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, insertRejectProd.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, insertRejectProd.NUM_LIGNE_REJET);

                        if(insertRejectProd.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, insertRejectProd.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, insertRejectProd.LB_CHEMIN_FICHIER);
}

                        if(insertRejectProd.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertRejectProd.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, insertRejectProd.NUM_LIGNE_REJET);

                        if(insertRejectProd.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, insertRejectProd.LB_LIGNE_REJET);
}

                        if(insertRejectProd.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, insertRejectProd.LB_MESSAGE_REJET);
}

                        if(insertRejectProd.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, insertRejectProd.LB_NOM_FLUX);
}

                        if(insertRejectProd.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(insertRejectProd.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, insertRejectProd.LB_JOB_NAME);
}
...
} // End of branch "insertRejectProd"
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"produitClean");
			  	}
...
globalMap.put("tDBOutput_5_ERROR_MESSAGE",e_tDBOutput_5.getMessage());
	...
	nb_line_rejected_tDBOutput_5=nb_line_rejected_tDBOutput_5 + rejectedCount_tDBOutput_5;
        ...
        globalMap.put("tDBOutput_5_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_5);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"UpdateBLCurrentProduit");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertProdDuplicates");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertRejectProd");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// linked node: tMap_4 - inputs:(row5,row6) outputs:(produitClean,sousCategorieManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(produitClean,row7) outputs:(insertProduit,UpdateBLCurrentProduit,insertNewValueProduit)
...
/************************************************************************************************
 *     407408 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 août 2024 à 11:49:39 GMT
 ************************************************************************************************/