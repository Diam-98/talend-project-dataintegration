...
/**
 * Job: jOdsVente Purpose: Alimenter la table ODS Vente<br>
 * Description: Permet d'alimenter la table ODS Vente <br>
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_1 = context.projetFolder + TalendDate.getDate("YYYYMMDD");
...
public static class insertRejectVenteStruct implements routines.system.IPersistableRow<insertRejectVenteStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final insertRejectVenteStruct other = (insertRejectVenteStruct) obj;
	...
	public void copyDataTo(insertRejectVenteStruct other) {
	...
	public void copyKeysDataTo(insertRejectVenteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertRejectVenteStruct other) {
...
public static class insertDuplicatesVenteStruct implements routines.system.IPersistableRow<insertDuplicatesVenteStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertDuplicatesVenteStruct other = (insertDuplicatesVenteStruct) obj;
	...
	public void copyDataTo(insertDuplicatesVenteStruct other) {
	...
	public void copyKeysDataTo(insertDuplicatesVenteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertDuplicatesVenteStruct other) {
...
public static class venteExistanteStruct implements routines.system.IPersistableRow<venteExistanteStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final venteExistanteStruct other = (venteExistanteStruct) obj;
	...
	public void copyDataTo(venteExistanteStruct other) {
	...
	public void copyKeysDataTo(venteExistanteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(venteExistanteStruct other) {
...
public static class venteProduitStruct implements routines.system.IPersistableRow<venteProduitStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(venteProduitStruct other) {
...
public static class venteClientStruct implements routines.system.IPersistableRow<venteClientStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(venteClientStruct other) {
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
	...
	public void copyDataTo(row2Struct other) {
		...
		other.ID_VENTE = this.ID_VENTE;
	            ...
	            other.NUM_LIGNE = this.NUM_LIGNE;
...
public static class venteNumLigneStruct implements routines.system.IPersistableRow<venteNumLigneStruct> {
    final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
    static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final venteNumLigneStruct other = (venteNumLigneStruct) obj;
	...
	public void copyDataTo(venteNumLigneStruct other) {
	...
	public void copyKeysDataTo(venteNumLigneStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(venteNumLigneStruct other) {
...
venteNumLigneStruct venteNumLigne = new venteNumLigneStruct();
row2Struct row2 = new row2Struct();
row5Struct row5 = new row5Struct();
venteClientStruct venteClient = new venteClientStruct();
venteProduitStruct venteProduit = new venteProduitStruct();
insertVenteStruct insertVente = new insertVenteStruct();
venteExistanteStruct venteExistante = new venteExistanteStruct();
...
insertDuplicatesVenteStruct insertDuplicatesVente = new insertDuplicatesVenteStruct();
row3Struct row3 = new row3Struct();
insertRejectVenteStruct insertRejectVente = new insertRejectVenteStruct();
...
int count_tDBOutput_5=0;
	    String insert_tDBOutput_5 = "INSERT INTO \"" + tableName_tDBOutput_5 + "\" (\"ID_VENTE\",\"CD_PRODUIT\",\"DT_VENTE\",\"ID_CLIENT\",\"QTE_VENTE\",\"PRIX_ACHAT\",\"PRIX_VENTE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\",\"BL_LIGNE_IN_DWH\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"venteExistante");
					}
 ...
 */
	...
	currentComponent="tMap_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"venteProduit");
					}
...
venteExistanteStruct venteExistante_tmp = new venteExistanteStruct();
// ###############################
 ...
 */
	...
	currentComponent="tMap_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"venteClient");
					}
...
// ###############################
// # Outputs initialization
venteProduitStruct venteProduit_tmp = new venteProduitStruct();
...
// ###############################
// # Outputs initialization
venteClientStruct venteClient_tmp = new venteClientStruct();
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertDuplicatesVente");
					}
...
// ###############################
// # Outputs initialization
insertDuplicatesVenteStruct insertDuplicatesVente_tmp = new insertDuplicatesVenteStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertRejectVente");
					}
...
// ###############################
// # Outputs initialization
insertRejectVenteStruct insertRejectVente_tmp = new insertRejectVenteStruct();
// ###############################
 ...
 */
	...
	currentComponent="tFilterRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"venteNumLigne");
					}
...
// ###############################
// # Outputs initialization
venteNumLigneStruct venteNumLigne_tmp = new venteNumLigneStruct();
// ###############################
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(((String)globalMap.get("tFileList_1_CURRENT_FILEPATH")), context.encoding,context.fieldSeparator,"\n",true,1,0,
...
// # Output table : 'venteNumLigne'
venteNumLigne_tmp.ID_VENTE = row1.ID_VENTE ;
venteNumLigne_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
venteNumLigne_tmp.DT_VENTE = row1.DT_VENTE ;
venteNumLigne_tmp.ID_CLIENT = row1.ID_CLIENT ;
venteNumLigne_tmp.QTE_VENTE = row1.QTE_VENTE ;
venteNumLigne_tmp.PRIX_ACHAT = row1.PRIX_ACHAT ;
venteNumLigne_tmp.PRIX_VENTE = row1.PRIX_VENTE ;
venteNumLigne_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1);
venteNumLigne = venteNumLigne_tmp;
// ###############################
 ...
 */
// Start of branch "venteNumLigne"
if(venteNumLigne != null) { 
			row3 = null;
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// code sample : use venteNumLigne to define the condition.
// venteNumLigne.columnName1.equals("foo") ||!(venteNumLigne.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!venteNumLigne.ID_VENTE.isEmpty() &&
!venteNumLigne.CD_PRODUIT.isEmpty() &&
venteNumLigne.DT_VENTE != null &&
!venteNumLigne.ID_CLIENT.isEmpty() &&
venteNumLigne.QTE_VENTE != null &&
venteNumLigne.PRIX_ACHAT != null &&
venteNumLigne.PRIX_VENTE != null
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.ID_VENTE = venteNumLigne.ID_VENTE;
               row2.CD_PRODUIT = venteNumLigne.CD_PRODUIT;
               row2.DT_VENTE = venteNumLigne.DT_VENTE;
               row2.ID_CLIENT = venteNumLigne.ID_CLIENT;
               row2.QTE_VENTE = venteNumLigne.QTE_VENTE;
               row2.PRIX_ACHAT = venteNumLigne.PRIX_ACHAT;
               row2.PRIX_VENTE = venteNumLigne.PRIX_VENTE;
               row2.NUM_LIGNE = venteNumLigne.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row3 == null){
              row3 = new row3Struct();
            }
                row3.ID_VENTE = venteNumLigne.ID_VENTE;
                row3.CD_PRODUIT = venteNumLigne.CD_PRODUIT;
                row3.DT_VENTE = venteNumLigne.DT_VENTE;
                row3.ID_CLIENT = venteNumLigne.ID_CLIENT;
                row3.QTE_VENTE = venteNumLigne.QTE_VENTE;
                row3.PRIX_ACHAT = venteNumLigne.PRIX_ACHAT;
                row3.PRIX_VENTE = venteNumLigne.PRIX_VENTE;
                row3.NUM_LIGNE = venteNumLigne.NUM_LIGNE;
...
if(row2.CD_PRODUIT == null){
	...
	row5 = new row5Struct();
}row5.ID_VENTE = row2.ID_VENTE;			row5.CD_PRODUIT = row2.CD_PRODUIT;			row5.DT_VENTE = row2.DT_VENTE;			row5.ID_CLIENT = row2.ID_CLIENT;			row5.QTE_VENTE = row2.QTE_VENTE;			row5.PRIX_ACHAT = row2.PRIX_ACHAT;			row5.PRIX_VENTE = row2.PRIX_VENTE;			row5.NUM_LIGNE = row2.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row4 == null){ 
	
	row4 = new row4Struct();
}				row4.ID_VENTE = row2.ID_VENTE;			row4.CD_PRODUIT = row2.CD_PRODUIT;			row4.DT_VENTE = row2.DT_VENTE;			row4.ID_CLIENT = row2.ID_CLIENT;			row4.QTE_VENTE = row2.QTE_VENTE;			row4.PRIX_ACHAT = row2.PRIX_ACHAT;			row4.PRIX_VENTE = row2.PRIX_VENTE;			row4.NUM_LIGNE = row2.NUM_LIGNE;			
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		    ...
                        		    		    row6HashKey.ID_CLIENT = row5.ID_CLIENT ;
								  ...
								  if(!tHash_Lookup_row6.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.ID_CLIENT = '" + row6HashKey.ID_CLIENT + "'");
								} // G 071
...
// # Output table : 'venteClient'
venteClient_tmp.ID_VENTE = row5.ID_VENTE ;
venteClient_tmp.CD_PRODUIT = row5.CD_PRODUIT ;
venteClient_tmp.DT_VENTE = row5.DT_VENTE ;
venteClient_tmp.ID_CLIENT = row5.ID_CLIENT ;
venteClient_tmp.QTE_VENTE = row5.QTE_VENTE ;
venteClient_tmp.PRIX_ACHAT = row5.PRIX_ACHAT ;
venteClient_tmp.PRIX_VENTE = row5.PRIX_VENTE ;
venteClient_tmp.NUM_LIGNE = row5.NUM_LIGNE ;
venteClient = venteClient_tmp;
...
ClientManquant_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE ;
ClientManquant_tmp.LB_LIGNE_REJET = row5.ID_VENTE +"|"+ row5.CD_PRODUIT +"|"+ row5.DT_VENTE +"|"+ row5.ID_CLIENT +"|"+ row5.QTE_VENTE +"|"+ row5.PRIX_ACHAT +"|"+ row5.PRIX_VENTE ;
ClientManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> Client "+row5.ID_CLIENT + " n'existe pas dans la table ODS_CLIENT" ;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_PRODUIT = venteClient.CD_PRODUIT ;
...
// # Output table : 'venteProduit'
venteProduit_tmp.ID_VENTE = venteClient.ID_VENTE ;
venteProduit_tmp.CD_PRODUIT = venteClient.CD_PRODUIT ;
venteProduit_tmp.DT_VENTE = venteClient.DT_VENTE ;
venteProduit_tmp.ID_CLIENT = venteClient.ID_CLIENT ;
venteProduit_tmp.QTE_VENTE = venteClient.QTE_VENTE ;
venteProduit_tmp.PRIX_ACHAT = venteClient.PRIX_ACHAT ;
venteProduit_tmp.PRIX_VENTE = venteClient.PRIX_VENTE ;
venteProduit_tmp.NUM_LIGNE = venteClient.NUM_LIGNE ;
venteProduit = venteProduit_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 
...
produitManquant_tmp.NUM_LIGNE_REJET = venteClient.NUM_LIGNE ;
produitManquant_tmp.LB_LIGNE_REJET = venteClient.ID_VENTE +"|"+ venteClient.CD_PRODUIT +"|"+ venteClient.DT_VENTE +"|"+ venteClient.ID_CLIENT +"|"+ venteClient.QTE_VENTE  +"|"+ venteClient.PRIX_ACHAT +"|"+ venteClient.PRIX_VENTE ;
produitManquant_tmp.LB_MESSAGE_REJET = "Dependance ==> Produit "+venteClient. CD_PRODUIT + " n'existe pas dans la table ODS_PRODUIT" ;
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_6 = false;
                        		    		    ...
                        		    		    row8HashKey.ID_VENTE = venteProduit.ID_VENTE ;
				           		...
				           		if(tHash_Lookup_row8 != null && tHash_Lookup_row8.getCount(row8HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.ID_VENTE = '" + row8HashKey.ID_VENTE + "'");
								} // G 071
...
insertVente_tmp.ID_VENTE = venteProduit.ID_VENTE ;
insertVente_tmp.CD_PRODUIT = venteProduit.CD_PRODUIT ;
insertVente_tmp.DT_VENTE = venteProduit.DT_VENTE ;
insertVente_tmp.ID_CLIENT = venteProduit.ID_CLIENT ;
insertVente_tmp.QTE_VENTE = venteProduit.QTE_VENTE ;
insertVente_tmp.PRIX_ACHAT = venteProduit.PRIX_ACHAT ;
insertVente_tmp.PRIX_VENTE = venteProduit.PRIX_VENTE ;
...
insertVente_tmp.BL_LIGNE_IN_DWH = false;
insertVente = insertVente_tmp;

// # Output table : 'venteExistante'
venteExistante_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
venteExistante_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
venteExistante_tmp.NUM_LIGNE_REJET = venteProduit.NUM_LIGNE ;
venteExistante_tmp.LB_LIGNE_REJET = venteProduit.ID_VENTE +"|"+ venteProduit.CD_PRODUIT +"|"+ venteProduit.DT_VENTE +"|"+ venteProduit.ID_CLIENT +"|"+ venteProduit.QTE_VENTE +"|"+ venteProduit.PRIX_ACHAT +"|"+ venteProduit.PRIX_VENTE ;
venteExistante_tmp.LB_MESSAGE_REJET = "Donnees deja insere dans la table";
venteExistante_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
venteExistante_tmp.DT_REJET = TalendDate.getCurrentDate();
venteExistante_tmp.LB_JOB_NAME = jobName;
venteExistante = venteExistante_tmp;
// ###############################
...
} else {pstmt_tDBOutput_5.setString(1, insertVente.ID_VENTE);
}

                    if(insertVente.CD_PRODUIT == null) {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(2, insertVente.CD_PRODUIT);
}

                    if(insertVente.DT_VENTE != null) {
pstmt_tDBOutput_5.setTimestamp(3, new java.sql.Timestamp(insertVente.DT_VENTE.getTime()));
} else {
...
} else {pstmt_tDBOutput_5.setString(4, insertVente.ID_CLIENT);
}

                    pstmt_tDBOutput_5.setInt(5, insertVente.QTE_VENTE);

                    pstmt_tDBOutput_5.setBigDecimal(6, insertVente.PRIX_ACHAT);

                    pstmt_tDBOutput_5.setBigDecimal(7, insertVente.PRIX_VENTE);

                    if(insertVente.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(8, insertVente.LB_NOM_FICHIER);
}

                    if(insertVente.DT_INSERTION != null) {
pstmt_tDBOutput_5.setTimestamp(9, new java.sql.Timestamp(insertVente.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_5.setString(10, insertVente.LB_JOB_NAME);
}

                    pstmt_tDBOutput_5.setBoolean(11, insertVente.BL_LIGNE_IN_DWH);
...
// Start of branch "venteExistante"
if(venteExistante != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(venteExistante.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, venteExistante.LB_CHEMIN_FICHIER);
}

                    if(venteExistante.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, venteExistante.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, venteExistante.NUM_LIGNE_REJET);

                    if(venteExistante.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, venteExistante.LB_LIGNE_REJET);
}

                    if(venteExistante.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, venteExistante.LB_MESSAGE_REJET);
}

                    if(venteExistante.LB_NOM_FLUX == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, venteExistante.LB_NOM_FLUX);
}

                    if(venteExistante.DT_REJET != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(venteExistante.DT_REJET.getTime()));
} else {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(venteExistante.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(8, venteExistante.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_4.setString(1, produitManquant.LB_CHEMIN_FICHIER);
}

                    if(produitManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, produitManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_4.setInt(3, produitManquant.NUM_LIGNE_REJET);

                    if(produitManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(4, produitManquant.LB_LIGNE_REJET);
}

                    if(produitManquant.LB_MESSAGE_REJET == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, produitManquant.LB_MESSAGE_REJET);
}

                    if(produitManquant.LB_NOM_FLUX == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, produitManquant.LB_NOM_FLUX);
}

                    if(produitManquant.DT_REJET != null) {
pstmt_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(produitManquant.DT_REJET.getTime()));
} else {
...
} else {pstmt_tDBOutput_4.setString(8, produitManquant.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_3.setString(1, ClientManquant.LB_CHEMIN_FICHIER);
}

                    if(ClientManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_3.setInt(3, ClientManquant.NUM_LIGNE_REJET);

                    if(ClientManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, ClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_3.setString(1, ClientManquant.LB_MESSAGE_REJET);
}

                        if(ClientManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FLUX);
}

                        if(ClientManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_3.setString(4, ClientManquant.LB_JOB_NAME);
}

                        if(ClientManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5 + count_tDBOutput_3, ClientManquant.LB_CHEMIN_FICHIER);
}

                        if(ClientManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3, ClientManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_3.setInt(7 + count_tDBOutput_3, ClientManquant.NUM_LIGNE_REJET);

                        if(ClientManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3, ClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, ClientManquant.LB_CHEMIN_FICHIER);
}

                        if(ClientManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, ClientManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_3.setInt(3, ClientManquant.NUM_LIGNE_REJET);

                        if(ClientManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, ClientManquant.LB_LIGNE_REJET);
}

                        if(ClientManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, ClientManquant.LB_MESSAGE_REJET);
}

                        if(ClientManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, ClientManquant.LB_NOM_FLUX);
}

                        if(ClientManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(ClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(8, ClientManquant.LB_JOB_NAME);
}
...
insertDuplicatesVente = null;


// # Output table : 'insertDuplicatesVente'
insertDuplicatesVente_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
insertDuplicatesVente_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertDuplicatesVente_tmp.NUM_LIGNE_REJET = row4.NUM_LIGNE ;
insertDuplicatesVente_tmp.LB_LIGNE_REJET = row4.ID_VENTE +"|"+ row4.CD_PRODUIT +"|"+ row4.DT_VENTE +"|"+ row4.ID_CLIENT +"|"+ row4.QTE_VENTE +"|"+ row4.PRIX_ACHAT +"|"+ row4.PRIX_VENTE ;
insertDuplicatesVente_tmp.LB_MESSAGE_REJET = "Lignes en doubles";
insertDuplicatesVente_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
insertDuplicatesVente_tmp.DT_REJET = TalendDate.getCurrentDate();
insertDuplicatesVente_tmp.LB_JOB_NAME = jobName;
insertDuplicatesVente = insertDuplicatesVente_tmp;
// ###############################
 ...
 */
// Start of branch "insertDuplicatesVente"
if(insertDuplicatesVente != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(insertDuplicatesVente.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, insertDuplicatesVente.LB_CHEMIN_FICHIER);
}

                    if(insertDuplicatesVente.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertDuplicatesVente.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_2.setInt(3, insertDuplicatesVente.NUM_LIGNE_REJET);

                    if(insertDuplicatesVente.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertDuplicatesVente.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_2 > 0) {
                        if(insertDuplicatesVente.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(1, insertDuplicatesVente.LB_MESSAGE_REJET);
}

                        if(insertDuplicatesVente.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, insertDuplicatesVente.LB_NOM_FLUX);
}

                        if(insertDuplicatesVente.DT_REJET != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(insertDuplicatesVente.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(insertDuplicatesVente.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(4, insertDuplicatesVente.LB_JOB_NAME);
}

                        if(insertDuplicatesVente.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2, insertDuplicatesVente.LB_CHEMIN_FICHIER);
}

                        if(insertDuplicatesVente.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, insertDuplicatesVente.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, insertDuplicatesVente.NUM_LIGNE_REJET);

                        if(insertDuplicatesVente.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(8 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2, insertDuplicatesVente.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, insertDuplicatesVente.LB_CHEMIN_FICHIER);
}

                        if(insertDuplicatesVente.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, insertDuplicatesVente.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_2.setInt(3, insertDuplicatesVente.NUM_LIGNE_REJET);

                        if(insertDuplicatesVente.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, insertDuplicatesVente.LB_LIGNE_REJET);
}

                        if(insertDuplicatesVente.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, insertDuplicatesVente.LB_MESSAGE_REJET);
}

                        if(insertDuplicatesVente.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, insertDuplicatesVente.LB_NOM_FLUX);
}

                        if(insertDuplicatesVente.DT_REJET != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(insertDuplicatesVente.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_2.setString(8, insertDuplicatesVente.LB_JOB_NAME);
}
...
} // End of branch "insertDuplicatesVente"
...
insertRejectVente = null;


// # Output table : 'insertRejectVente'
insertRejectVente_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
insertRejectVente_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertRejectVente_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
insertRejectVente_tmp.LB_LIGNE_REJET = row3.ID_VENTE +"|"+ row3.CD_PRODUIT  +"|"+ row3.DT_VENTE +"|"+ row3.ID_CLIENT +"|"+ row3.QTE_VENTE +"|"+ row3.PRIX_ACHAT +"|"+ row3.PRIX_VENTE ;
insertRejectVente_tmp.LB_MESSAGE_REJET = row3.errorMessage ;
insertRejectVente_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
insertRejectVente_tmp.DT_REJET = TalendDate.getCurrentDate();
insertRejectVente_tmp.LB_JOB_NAME = jobName;
insertRejectVente = insertRejectVente_tmp;
// ###############################
 ...
 */
// Start of branch "insertRejectVente"
if(insertRejectVente != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insertRejectVente.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insertRejectVente.LB_CHEMIN_FICHIER);
}

                    if(insertRejectVente.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_1.setInt(3, insertRejectVente.NUM_LIGNE_REJET);

                    if(insertRejectVente.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, insertRejectVente.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(insertRejectVente.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, insertRejectVente.LB_MESSAGE_REJET);
}

                        if(insertRejectVente.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FLUX);
}

                        if(insertRejectVente.DT_REJET != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(insertRejectVente.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(insertRejectVente.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, insertRejectVente.LB_JOB_NAME);
}

                        if(insertRejectVente.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, insertRejectVente.LB_CHEMIN_FICHIER);
}

                        if(insertRejectVente.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, insertRejectVente.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, insertRejectVente.NUM_LIGNE_REJET);

                        if(insertRejectVente.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, insertRejectVente.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, insertRejectVente.LB_CHEMIN_FICHIER);
}

                        if(insertRejectVente.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, insertRejectVente.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_1.setInt(3, insertRejectVente.NUM_LIGNE_REJET);

                        if(insertRejectVente.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, insertRejectVente.LB_LIGNE_REJET);
}

                        if(insertRejectVente.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, insertRejectVente.LB_MESSAGE_REJET);
}

                        if(insertRejectVente.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, insertRejectVente.LB_NOM_FLUX);
}

                        if(insertRejectVente.DT_REJET != null) {
pstmtInsert_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(insertRejectVente.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(8, insertRejectVente.LB_JOB_NAME);
}
...
} // End of branch "insertRejectVente"
 ...
 */
    ...
    globalMap.put("tFilterRow_1_NB_LINE_REJECT", nb_line_reject_tFilterRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"venteNumLigne");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"venteClient");
			  	}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"venteProduit");
			  	}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"venteExistante");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertDuplicatesVente");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertRejectVente");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tDBInput_1 - inputs:(after_tFileInputDelimited_1) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_4 - inputs:(row5,row6) outputs:(venteClient,ClientManquant)
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
        	...
        	row6.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row6.NOM_CLIENT = null;
							} else {
	                         		
        	row6.NOM_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row6.PREN_CLIENT = null;
							} else {
	                         		
        	row6.PREN_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row6.CD_POSTAL_CLIENT = null;
							} else {
	                         		
        	row6.CD_POSTAL_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row6.VILLE_CLIENT = null;
							} else {
	                         		
        	row6.VILLE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row6.PAYS_CLIENT = null;
							} else {
	                         		
        	row6.PAYS_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row6.REGION_CLIENT = null;
							} else {
	                         		
        	row6.REGION_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row6.CD_TYPE_CLIENT = null;
							} else {
	                         		
        	row6.CD_TYPE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row6.LB_NOM_FICHIER = null;
							} else {
	                         		
        	row6.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row6.DT_INSERTION = null;
							} else {
										
			row6.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 10);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row6.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row6.BL_LIGNE_ACTIVE = rs_tDBInput_1.getInt(11);
        	...
        	row6.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.NOM_CLIENT = row6.NOM_CLIENT;
				
				row6_HashRow.PREN_CLIENT = row6.PREN_CLIENT;
				
				row6_HashRow.CD_POSTAL_CLIENT = row6.CD_POSTAL_CLIENT;
				
				row6_HashRow.VILLE_CLIENT = row6.VILLE_CLIENT;
				
				row6_HashRow.PAYS_CLIENT = row6.PAYS_CLIENT;
				
				row6_HashRow.REGION_CLIENT = row6.REGION_CLIENT;
				
				row6_HashRow.CD_TYPE_CLIENT = row6.CD_TYPE_CLIENT;
				
				row6_HashRow.LB_NOM_FICHIER = row6.LB_NOM_FICHIER;
				
				row6_HashRow.DT_INSERTION = row6.DT_INSERTION;
				
				row6_HashRow.BL_LIGNE_ACTIVE = row6.BL_LIGNE_ACTIVE;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(venteClient,row7) outputs:(venteProduit,produitManquant)
...
public static class row8Struct implements routines.system.IPersistableComparableLookupRow<row8Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.CD_PRODUIT = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.CD_PRODUIT = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.CD_PRODUIT, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.CD_PRODUIT, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// linked node: tMap_6 - inputs:(venteProduit,row8) outputs:(insertVente,venteExistante)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
        	...
        	row8.ID_VENTE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row8.CD_PRODUIT = null;
							} else {
	                         		
        	row8.CD_PRODUIT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row8.DT_VENTE = null;
							} else {
										
			row8.DT_VENTE = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 3);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row8.ID_CLIENT = null;
							} else {
	                         		
        	row8.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row8.QTE_VENTE = 0;
							} else {
		                          
            row8.QTE_VENTE = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row8.PRIX_ACHAT = null;
							} else {
		                          
            row8.PRIX_ACHAT = rs_tDBInput_3.getBigDecimal(6);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row8.PRIX_VENTE = null;
							} else {
		                          
            row8.PRIX_VENTE = rs_tDBInput_3.getBigDecimal(7);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row8.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 9) {
								row8.DT_INSERTION = null;
							} else {
										
			row8.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 9);
		                    }
							if(colQtyInRs_tDBInput_3 < 10) {
								row8.LB_JOB_NAME = null;
							} else {
	                         		
        	row8.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 10, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 11) {
								row8.BL_LIGNE_IN_DWH = false;
							} else {
	                         		
            row8.BL_LIGNE_IN_DWH = rs_tDBInput_3.getBoolean(11);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
				...
				row8_HashRow.ID_VENTE = row8.ID_VENTE;
				
				row8_HashRow.CD_PRODUIT = row8.CD_PRODUIT;
				
				row8_HashRow.DT_VENTE = row8.DT_VENTE;
				
				row8_HashRow.ID_CLIENT = row8.ID_CLIENT;
				
				row8_HashRow.QTE_VENTE = row8.QTE_VENTE;
				
				row8_HashRow.PRIX_ACHAT = row8.PRIX_ACHAT;
				
				row8_HashRow.PRIX_VENTE = row8.PRIX_VENTE;
				...
				row8_HashRow.BL_LIGNE_IN_DWH = row8.BL_LIGNE_IN_DWH;
...
/************************************************************************************************
 *     476350 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 août 2024 à 11:49:42 GMT
 ************************************************************************************************/